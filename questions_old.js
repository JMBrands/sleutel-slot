...
//    ViewScr : 'load ok.mol; frames all; color atoms [x001E55]; spacefill off; wireframe off; moveto 0 1 0 0 90 0 0 -55; wireframe 60; set spinX 90; set spinY 0; set spinZ 0; echo; moveto 1 0 0 0 0 0 0 0; spin on;',
  ...
  ////////// 4 - find the pocket \\\\\\\\\\
  {
    ...
    Stereo  : 1,
    Meter   : null,
    PreScr  : 'spacefill off; wireframe off; load 2HYY.mol2; spacefill off; wireframe off; moveto 0 1 1 1 -180 -60 -60 -60; wireframe 38; moveto 4 0 0 0 0 0; delay 0.000001; isoSurface Iso_Full model 1.2 "2HYY.jvxl"; color $Iso_Full translucent 1.00 ', 
    ...
    PostScr : 'draw off; color $Iso_Full translucent 0.00; hide 0; spin off'
  },
  ////////// 5 - De natuurlijke sleutel \\\\\\\\\\
  {
    ...
    Stereo  : 1,
    Meter   : null,
    PreScr  : 'moveto 2 {914 366 174 136.62} 221.28 0 22.8; delay 0.1; isoSurface Iso_Part model 1.2 "2HYY_R0.jvxl"; TransLucentVal = 0.00; load append "ATP.sdf";  set backgroundmodel 1.2; hide 1.1; ', 
    ...
    PostScr : 'moveto 2 {914 366 174 136.62} 221.28 0 22.8; color $Iso_Full translucent 1.00 ; hide all; spin off'
  },  
  ...
  ////////// 7 - find the pocket R1 group \\\\\\\\\\
  {
    ...
    ViewScr : null,
    PostScr : 'frame 4.3; display 4.3; moveto 2 {930 141 340 142} 100 0 0 ; TransLucentVal = 1.00; message _loop1; if ( @TransLucentVal > 0);  color $Iso_Full translucent @TransLucentVal; TransLucentVal = @TransLucentVal-0.1; delay 0.2; goto _loop1; else; color $Iso_Full translucent 0.00; endif; spin off'
  },
  ////////// 8 - set the right donors acceptors for the R1 group (R1B) \\\\\\\\\\
{
    ...
    Stereo  : null,
    Meter   : null,
    PreScr  : 'isoSurface Iso_Part model 1.2 "2HYY_R1.jvxl"; set backgroundmodel 1.2; frame 4.3; TransLucentVal = 0.00; message _loop1; if ( @TransLucentVal < 1);  color $Iso_Full translucent @TransLucentVal; TransLucentVal = @TransLucentVal+0.1; delay 0.2; goto _loop1; else; color $Iso_Full translucent 1.00; endif; moveto 2 {772 522 363 87.5} 370 -4.2 29.0; load append "R1B.sdf"; set backgroundmodel 1.2; frame 4.3; isoSurface Iso_Part_MEP model 1.2 "2HYY_R1_mep.jvxl"  translucent 1.0; isoSurface Iso_Full_MEP model 1.2 "2HYY_mep.jvxl" translucent 1.0;', 
    ...
    PostScr : 'color $Iso_Part_MEP translucent 0.0; color $Iso_Part translucent 1.0; frame 5.3; display 5.3; moveto 2 {930 141 340 142} 100 0 0 ; TransLucentVal = 1.00; message _loop1; if ( @TransLucentVal > 0);  color $Iso_Full_MEP translucent @TransLucentVal; TransLucentVal = @TransLucentVal-0.1; delay 0.2; goto _loop1; else; color $Iso_Full_MEP translucent 0.00; color $Iso_Part_MEP translucent 1.0; endif; spin off'
  },
  ////////// 9 - find the right R2 group \\\\\\\\\\
{
    ...
    Stereo  : null,
    Meter   : null,
    PreScr  : 'isoSurface Iso_Part_MEP model 1.2 "2HYY_R2_mep.jvxl"0; set backgroundmodel 1.2; frame 5.3; TransLucentVal = 0.00; message _loop1; if ( @TransLucentVal < 1);  color $Iso_Full_MEP translucent @TransLucentVal; TransLucentVal = @TransLucentVal+0.1; delay 0.3; goto _loop1; else; color $Iso_Full_MEP translucent 1.00; endif; moveto 2 { -965 214 -148 138.2} 275 -11.5 18.9;  load append "R2.sdf"; set backgroundmodel 1.2; frame 5.3;', 
    ViewScr : null,
  ...
  ////////// 10 - find the right position of the Me R3 \\\\\\\\\\
{
    ...
    Stereo  : 1,
    Meter   : null,
    PreScr  : 'isoSurface Iso_Part_MEP model 1.2 "2HYY_R3_mep.jvxl"; set backgroundmodel 1.2; frame 6.1; TransLucentVal = 0.00; message _loop1; if ( @TransLucentVal < 1);  color $Iso_Full_MEP translucent @TransLucentVal;  TransLucentVal = @TransLucentVal+0.1; delay 0.3; goto _loop1; else; color $Iso_Full_MEP translucent 1.00; endif; moveto 2 {432 -247 868 159} 280 -1.2 34.2; load append "R3.sdf"; set backgroundmodel 1.2; frame 6.1;', 
    ViewScr : null,
    PostScr : 'frame 7.2; display 7.2; moveto 2 {930 141 340 142} 100 0 0 ; TransLucentVal = 1.00; message _loop1; if ( @TransLucentVal > 0);  color $Iso_Full_MEP translucent @TransLucentVal; TransLucentVal = @TransLucentVal-0.1; delay 0.2; goto _loop1; else; color $Iso_Full_MEP translucent 0.00; color $Iso_Part_MEP translucent 1.00; endif; spin off'
  },
  ////////// 11 - find the right position of the solubaliser \\\\\\\\\\
{
  ...
  ////////// 12 - Glivec \\\\\\\\\\
  {
    Type    : TText,
    Head    : 'Glivec',
    Text    : 'Het molecuul wat je hebt gemaakt is de aktieve stof in een echt bestaand geneesmiddel. Het molecuul heet Imatinib en bindt sterk aan het eiwit. Hierdoor kan ATP niet meer aan dit eiwit binden en kan dit eiwit niet meer geaktiveerd worden. De ongeremde celdeling wordt hierdoor gestopt. Sinds 2001 is dit molecuul onder de naam Glivec (Gleevec) beschikbaar voor de behandeling van leukemie. Novartis heeft dit middel ontwikkeld, en sindsdien zien er wereldwijd al vele patienten mee behandeld.',
    Help    : null,
    Note    : null,
    Stereo  : 1,
    Meter   : null,
    PreScr  : 'TransLucentVal = 0.00; message _loop1; if ( @TransLucentVal < 1);  color $Iso_Full_MEP translucent @TransLucentVal; TransLucentVal = @TransLucentVal+0.1; delay 0.2; goto _loop1; else; color $Iso_Full_MEP translucent 1.00; endif; moveto 2 {794 498 -349 76.08} 320.44 8.0 12.83', 
