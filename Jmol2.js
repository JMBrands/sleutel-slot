(function (a, m) { "object" === typeof module && "object" === typeof module.exports ? module.exports = a.document ? m(a, !0) : function (a) { if (!a.document) throw Error("jQuery requires a window with a document"); return m(a) } : m(a) })("undefined" !== typeof window ? window : this, function (a, m) {
	function l(g) { var a = g.length, p = f.type(g); return "function" === p || f.isWindow(g) ? !1 : 1 === g.nodeType && a ? !0 : "array" === p || 0 === a || "number" === typeof a && 0 < a && a - 1 in g } function h(g, a, p) {
	...
	} function d() { return !0 } function q() { return !1 } function K() { try { return y.activeElement } catch (g) { } } function T(g) {
		var a = mc.split("|"); g = g.createDocumentFragment(); if (g.createElement) for (; a.length;)g.createElement(a.pop());
		return g
	} function C(g, a) { var p, b, c = 0, k = typeof g.getElementsByTagName !== ja ? g.getElementsByTagName(a || "*") : typeof g.querySelectorAll !== ja ? g.querySelectorAll(a || "*") : void 0; if (!k) { k = []; for (p = g.childNodes || g; null != (b = p[c]); c++)!a || f.nodeName(b, a) ? k.push(b) : f.merge(k, C(b, a)) } return void 0 === a || a && f.nodeName(g, a) ? f.merge([g], k) : k } function rb(g) { Mb.test(g.type) && (g.defaultChecked = g.checked) } function Ya(g, a) {
	...
	} function Ca(g) { g.type = (null !== f.find.attr(g, "type")) + "/" + g.type; return g } function U(g) { var a = Yc.exec(g.type); a ? g.type = a[1] : g.removeAttribute("type"); return g } function O(g, a) { for (var p, b = 0; null != (p = g[b]); b++)f._data(p, "globalEval", !a || f._data(a[b], "globalEval")) } function Da(g, a) {
		...
		a) { return { get: function () { var p = g(); if (null != p) if (p) delete this.get; else return (this.get = a).apply(this, arguments) } } } function gb(g, a) { if (a in g) return a; for (var p = a.charAt(0).toUpperCase() + a.slice(1), b = a, f = oc.length; f--;)if (a = oc[f] + p, a in g) return a; return b } function ta(g, a) {
		...
		} function ka(g, a, p) { return (g = Zc.exec(a)) ? Math.max(0, g[1] - (p || 0)) + (g[2] || "px") : a } function w(g, a, p, b, c) {
		...
		} function V(g, a, p) { var b = !0, k = "width" === a ? g.offsetWidth : g.offsetHeight, c = Pa(g), d = v.boxSizing() && "border-box" === f.css(g, "boxSizing", !1, c); if (0 >= k || null == k) { k = Qa(g, a, c); if (0 > k || null == k) k = g.style[a]; if (sb.test(k)) return k; b = d && (v.boxSizingReliable() || k === g.style[a]); k = parseFloat(k) || 0 } return k + w(g, a, p || (d ? "border" : "content"), b, c) + "px" } function H(g, a, p, b, f) {
			return new H.prototype.init(g,
				a, p, b, f)
		} function ea() { setTimeout(function () { Za = void 0 }); return Za = f.now() } function L(g, a) { var p, b = { height: g }, f = 0; for (a = a ? 1 : 0; 4 > f; f += 2 - a)p = Oa[f], b["margin" + p] = b["padding" + p] = g; a && (b.opacity = b.width = g); return b } function ua(g, a, p) { for (var b, f = (ib[a] || []).concat(ib["*"]), k = 0, c = f.length; k < c; k++)if (b = f[k].call(p, a, g)) return b } function jb(g, a, p) {
			var b, k, c = 0, d = tb.length, n = f.Deferred().always(function () { delete e.elem }), e = function () {
				if (k) return !1; for (var a = Za || ea(), a = Math.max(0, r.startTime + r.duration - a), p =
					1 - (a / r.duration || 0), x = 0, b = r.tweens.length; x < b; x++)r.tweens[x].run(p); n.notifyWith(g, [r, p, a]); if (1 > p && b) return a; n.resolveWith(g, [r]); return !1
			}, r = n.promise({
				elem: g, props: f.extend({}, a), opts: f.extend(!0, { specialEasing: {} }, p), originalProperties: a, originalOptions: p, startTime: Za || ea(), duration: p.duration, tweens: [], createTween: function (a, p) { var x = f.Tween(g, r.opts, a, p, r.opts.specialEasing[a] || r.opts.easing); r.tweens.push(x); return x }, stop: function (a) {
					var p = 0, x = a ? r.tweens.length : 0; if (k) return this; for (k =
						!0; p < x; p++)r.tweens[p].run(1); a ? n.resolveWith(g, [r, a]) : n.rejectWith(g, [r, a]); return this
				}
			}); a = r.props; p = r.opts.specialEasing; var h, q, l, j; for (b in a) if (h = f.camelCase(b), q = p[h], l = a[b], f.isArray(l) && (q = l[1], l = a[b] = l[0]), b !== h && (a[h] = l, delete a[b]), (j = f.cssHooks[h]) && "expand" in j) for (b in l = j.expand(l), delete a[h], l) b in a || (a[b] = l[b], p[b] = q); else p[h] = q; for (; c < d; c++)if (b = tb[c].call(r, g, a, r.opts)) return b; f.map(a, ua, r); f.isFunction(r.opts.start) && r.opts.start.call(g, r); f.fx.timer(f.extend(e, {
				elem: g, anim: r,
				queue: r.opts.queue
			})); return r.progress(r.opts.progress).done(r.opts.done, r.opts.complete).fail(r.opts.fail).always(r.opts.always)
		} function kb(g) { return function (a, p) { "string" !== typeof a && (p = a, a = "*"); var b, k = 0, c = a.toLowerCase().match(va) || []; if (f.isFunction(p)) for (; b = c[k++];)"+" === b.charAt(0) ? (b = b.slice(1) || "*", (g[b] = g[b] || []).unshift(p)) : (g[b] = g[b] || []).push(p) } } function ub(g, a, p, b) {
			function k(n) {
				var e; c[n] = !0; f.each(g[n] || [], function (g, f) {
					var n = f(a, p, b); if ("string" === typeof n && !d && !c[n]) return a.dataTypes.unshift(n),
						k(n), !1; if (d) return !(e = n)
				}); return e
			} var c = {}, d = g === Nb; return k(a.dataTypes[0]) || !c["*"] && k("*")
		} function wa(g, a) { var p, b, k = f.ajaxSettings.flatOptions || {}; for (b in a) void 0 !== a[b] && ((k[b] ? g : p || (p = {}))[b] = a[b]); p && f.extend(!0, g, p); return g } function la(g, a, p, b) { var k; if (f.isArray(a)) f.each(a, function (a, x) { p || ad.test(g) ? b(g, x) : la(g + "[" + ("object" === typeof x ? a : "") + "]", x, p, b) }); else if (!p && "object" === f.type(a)) for (k in a) la(g + "[" + k + "]", a[k], p, b); else b(g, a) } function B(g) {
			try {
				return g ? new a.ActiveXObject("Microsoft.XMLHTTP") :
					new a.XMLHttpRequest
			} catch (x) { }
		} function W() { try { return new a.XMLHttpRequest } catch (g) { } } function ba(g) { return f.isWindow(g) ? g : 9 === g.nodeType ? g.defaultView || g.parentWindow : !1 } var k = [], n = k.slice, r = k.concat, z = k.push, E = k.indexOf, N = {}, bd = N.toString, xa = N.hasOwnProperty, Ob = "".trim, v = {}, f = function (g, a) { return new f.fn.init(g, a) }, cd = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, dd = /^-ms-/, ed = /-([\da-z])/gi, fd = function (g, a) { return a.toUpperCase() }; f.fn = f.prototype = {
			...
			var g, a, p, b, k, c = arguments[0] || {}, d = 1, n = arguments.length, e = !1; "boolean" === typeof c && (e = c, c = arguments[d] || {}, d++); "object" !== typeof c && !f.isFunction(c) && (c = {}); d === n && (c = this, d--); for (; d < n; d++)if (null != (k = arguments[d])) for (b in k) g = c[b], p = k[b], c !== p && (e && p && (f.isPlainObject(p) || (a = f.isArray(p))) ? (a ?
				(a = !1, g = g && f.isArray(g) ? g : []) : g = g && f.isPlainObject(g) ? g : {}, c[b] = f.extend(e, g, p)) : void 0 !== p && (c[b] = p)); return c
		}; f.extend({
			expando: "jQuery" + ("1.11.0" + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (g) { throw Error(g); }, noop: function () { }, isFunction: function (g) { return "function" === f.type(g) }, isArray: Array.isArray || function (g) { return "array" === f.type(g) }, isWindow: function (g) { return null != g && g == g.window }, isNumeric: function (g) { return 0 <= g - parseFloat(g) }, isEmptyObject: function (g) {
			...
			}, camelCase: function (g) { return g.replace(dd, "ms-").replace(ed, fd) }, nodeName: function (g, a) { return g.nodeName && g.nodeName.toLowerCase() === a.toLowerCase() }, each: function (g, a, p) { var b, f = 0, k = g.length; b = l(g); if (p) if (b) for (; f < k && !(b = a.apply(g[f], p), !1 === b); f++); else for (f in g) { if (b = a.apply(g[f], p), !1 === b) break } else if (b) for (; f < k && !(b = a.call(g[f], f, g[f]), !1 === b); f++); else for (f in g) if (b = a.call(g[f], f, g[f]), !1 === b) break; return g }, trim: Ob && !Ob.call("\ufeff\u00a0") ? function (g) { return null == g ? "" : Ob.call(g) } :
				function (g) { return null == g ? "" : (g + "").replace(cd, "") }, makeArray: function (g, a) { var p = a || []; null != g && (l(Object(g)) ? f.merge(p, "string" === typeof g ? [g] : g) : z.call(p, g)); return p }, inArray: function (g, a, p) { var b; if (a) { if (E) return E.call(a, g, p); b = a.length; for (p = p ? 0 > p ? Math.max(0, b + p) : p : 0; p < b; p++)if (p in a && a[p] === g) return p } return -1 }, merge: function (g, a) { for (var p = +a.length, b = 0, f = g.length; b < p;)g[f++] = a[b++]; if (p !== p) for (; void 0 !== a[b];)g[f++] = a[b++]; g.length = f; return g }, grep: function (g, a, p) {
					for (var b = [], f = 0, k =
						g.length, c = !p; f < k; f++)p = !a(g[f], f), p !== c && b.push(g[f]); return b
				}, map: function (g, a, p) { var b, f = 0, k = g.length, c = []; if (l(g)) for (; f < k; f++)b = a(g[f], f, p), null != b && c.push(b); else for (f in g) b = a(g[f], f, p), null != b && c.push(b); return r.apply([], c) }, guid: 1, proxy: function (g, a) { var p, b; "string" === typeof a && (b = g[a], a = g, g = b); if (f.isFunction(g)) return p = n.call(arguments, 2), b = function () { return g.apply(a || this, p.concat(n.call(arguments))) }, b.guid = g.guid = g.guid || f.guid++, b }, now: function () { return +new Date }, support: v
		});
	f.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function (g, a) { N["[object " + a + "]"] = a.toLowerCase() }); var Pb = a, D = function (g, a, p, b) {
		var f, k, c, d, n; (a ? a.ownerDocument || a : X) !== P && ma(a); a = a || P; p = p || []; if (!g || "string" !== typeof g) return p; if (1 !== (d = a.nodeType) && 9 !== d) return []; if (Y && !b) {
			if (f = gd.exec(g)) if (c = f[1]) if (9 === d) if ((k = a.getElementById(c)) && k.parentNode) { if (k.id === c) return p.push(k), p } else return p; else {
				if (a.ownerDocument && (k = a.ownerDocument.getElementById(c)) && ra(a,
					k) && k.id === c) return p.push(k), p
			} else { if (f[2]) return Ea.apply(p, a.getElementsByTagName(g)), p; if ((c = f[3]) && G.getElementsByClassName && a.getElementsByClassName) return Ea.apply(p, a.getElementsByClassName(c)), p } if (G.qsa && (!Q || !Q.test(g))) {
				k = f = I; c = a; n = 9 === d && g; if (1 === d && "object" !== a.nodeName.toLowerCase()) { d = sa(g); (f = a.getAttribute("id")) ? k = f.replace(hd, "\\$&") : a.setAttribute("id", k); k = "[id='" + k + "'] "; for (c = d.length; c--;)d[c] = k + vb(d[c]); c = Qb.test(g) && fa(a.parentNode) || a; n = d.join(",") } if (n) try {
					return Ea.apply(p,
						c.querySelectorAll(n)), p
				} catch (e) { } finally { f || a.removeAttribute("id") }
			}
		} var r; a: {
			g = g.replace(wb, "$1"); k = sa(g); if (!b && 1 === k.length) {
				f = k[0] = k[0].slice(0); if (2 < f.length && "ID" === (r = f[0]).type && G.getById && 9 === a.nodeType && Y && F.relative[f[1].type]) { a = (F.find.ID(r.matches[0].replace(Fa, Ga), a) || [])[0]; if (!a) { r = p; break a } g = g.slice(f.shift().value.length) } for (d = xb.needsContext.test(g) ? 0 : f.length; d--;) {
					r = f[d]; if (F.relative[c = r.type]) break; if (c = F.find[c]) if (b = c(r.matches[0].replace(Fa, Ga), Qb.test(f[0].type) &&
						fa(a.parentNode) || a)) { f.splice(d, 1); g = b.length && vb(f); if (!g) { Ea.apply(p, b); r = p; break a } break }
				}
			} $a(g, k)(b, a, !Y, p, Qb.test(g) && fa(a.parentNode) || a); r = p
		} return r
	}, Rb = function () { function g(p, b) { a.push(p + " ") > F.cacheLength && delete g[a.shift()]; return g[p + " "] = b } var a = []; return g }, R = function (g) { g[I] = !0; return g }, na = function (g) { var a = P.createElement("div"); try { return !!g(a) } catch (p) { return !1 } finally { a.parentNode && a.parentNode.removeChild(a) } }, Sb = function (g, a) {
		...
		return R(function (a) {
			a = +a; return R(function (p, b) {
				for (var f, k = g([], p.length, a), c = k.length; c--;)if (p[f = k[c]]) p[f] =
					!(b[f] = p[f])
			})
		})
	}, fa = function (g) { return g && typeof g.getElementsByTagName !== ga && g }, qc = function () { }, sa = function (g, a) {
		var p, b, f, k, c, d, n; if (c = Ha[g + " "]) return a ? 0 : c.slice(0); c = g; d = []; for (n = F.preFilter; c;) { if (!p || (b = kd.exec(c))) b && (c = c.slice(b[0].length) || c), d.push(f = []); p = !1; if (b = ld.exec(c)) p = b.shift(), f.push({ value: p, type: b[0].replace(wb, " ") }), c = c.slice(p.length); for (k in F.filter) if ((b = xb[k].exec(c)) && (!n[k] || (b = n[k](b)))) p = b.shift(), f.push({ value: p, type: k, matches: b }), c = c.slice(p.length); if (!p) break } return a ?
			c.length : c ? D.error(g) : Ha(g, d).slice(0)
	}, vb = function (g) { for (var a = 0, p = g.length, b = ""; a < p; a++)b += g[a].value; return b }, Tb = function (g, a, p) { var b = a.dir, f = p && "parentNode" === b, c = md++; return a.first ? function (a, p, x) { for (; a = a[b];)if (1 === a.nodeType || f) return g(a, p, x) } : function (a, p, x) { var k, d, n = [ca, c]; if (x) for (; a = a[b];) { if ((1 === a.nodeType || f) && g(a, p, x)) return !0 } else for (; a = a[b];)if (1 === a.nodeType || f) { d = a[I] || (a[I] = {}); if ((k = d[b]) && k[0] === ca && k[1] === c) return n[2] = k[2]; d[b] = n; if (n[2] = g(a, p, x)) return !0 } } }, Ub = function (g) {
		return 1 <
			g.length ? function (a, p, b) { for (var f = g.length; f--;)if (!g[f](a, p, b)) return !1; return !0 } : g[0]
	}, Sa = function (g, a, p, b, f) { for (var k, c = [], d = 0, n = g.length, e = null != a; d < n; d++)if (k = g[d]) if (!p || p(k, b, f)) c.push(k), e && a.push(d); return c }, Vb = function (g, a, p, b, f, k) {
		b && !b[I] && (b = Vb(b)); f && !f[I] && (f = Vb(f, k)); return R(function (k, c, d, n) {
			var e, r, qa = [], h = [], l = c.length, q; if (!(q = k)) { q = a || "*"; for (var j = d.nodeType ? [d] : d, A = [], z = 0, t = j.length; z < t; z++)D(q, j[z], A); q = A } q = g && (k || !a) ? Sa(q, qa, g, d, n) : q; j = p ? f || (k ? g : l || b) ? [] : c : q; p && p(q, j,
				d, n); if (b) { e = Sa(j, h); b(e, [], d, n); for (d = e.length; d--;)if (r = e[d]) j[h[d]] = !(q[h[d]] = r) } if (k) { if (f || g) { if (f) { e = []; for (d = j.length; d--;)if (r = j[d]) e.push(q[d] = r); f(null, j = [], e, n) } for (d = j.length; d--;)if ((r = j[d]) && -1 < (e = f ? Ta.call(k, r) : qa[d])) k[e] = !(c[e] = r) } } else j = Sa(j === c ? j.splice(l, j.length) : j), f ? f(null, c, j, n) : Ea.apply(c, j)
		})
	}, Wb = function (g) {
		var a, p, b, f = g.length, k = F.relative[g[0].type]; p = k || F.relative[" "]; for (var c = k ? 1 : 0, d = Tb(function (g) { return g === a }, p, !0), n = Tb(function (g) { return -1 < Ta.call(a, g) }, p, !0),
			e = [function (g, p, b) { return !k && (b || p !== ya) || ((a = p).nodeType ? d(g, p, b) : n(g, p, b)) }]; c < f; c++)if (p = F.relative[g[c].type]) e = [Tb(Ub(e), p)]; else { p = F.filter[g[c].type].apply(null, g[c].matches); if (p[I]) { for (b = ++c; b < f && !F.relative[g[b].type]; b++); return Vb(1 < c && Ub(e), 1 < c && vb(g.slice(0, c - 1).concat({ value: " " === g[c - 2].type ? "*" : "" })).replace(wb, "$1"), p, c < b && Wb(g.slice(c, b)), b < f && Wb(g = g.slice(b)), b < f && vb(g)) } e.push(p) } return Ub(e)
	}, za, G, F, Ia, rc, $a, ya, oa, Aa, ma, P, ha, Y, Q, pa, Ja, ra, I = "sizzle" + -new Date, X = Pb.document, ca =
			0, md = 0, sc = Rb(), Ha = Rb(), Ba = Rb(), A = function (g, a) { g === a && (Aa = !0); return 0 }, ga = "undefined", S = -2147483648, da = {}.hasOwnProperty, M = [], Z = M.pop, nd = M.push, Ea = M.push, tc = M.slice, Ta = M.indexOf || function (g) { for (var a = 0, p = this.length; a < p; a++)if (this[a] === g) return a; return -1 }, uc = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w", "w#"), vc = "\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + uc + ")|)|)[\\x20\\t\\r\\n\\f]*\\]",
		Xb = ":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + vc.replace(3, 8) + ")*)|.*)\\)|)", wb = RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$", "g"), kd = /^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/, ld = /^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/, od = RegExp("=[\\x20\\t\\r\\n\\f]*([^\\]'\"]*?)[\\x20\\t\\r\\n\\f]*\\]", "g"), pd = RegExp(Xb), qd = RegExp("^" + uc + "$"), xb = {
			...
			TAG: RegExp("^(" + "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w", "w*") + ")"), ATTR: RegExp("^" + vc), PSEUDO: RegExp("^" + Xb), CHILD: RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\([\\x20\\t\\r\\n\\f]*(even|odd|(([+-]|)(\\d*)n|)[\\x20\\t\\r\\n\\f]*(?:([+-]|)[\\x20\\t\\r\\n\\f]*(\\d+)|))[\\x20\\t\\r\\n\\f]*\\)|)", "i"), bool: RegExp("^(?:checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)$", "i"), needsContext: RegExp("^[\\x20\\t\\r\\n\\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\([\\x20\\t\\r\\n\\f]*((?:-\\d)?\\d*)[\\x20\\t\\r\\n\\f]*\\)|)(?=[^-]|$)",
				"i")
		}, rd = /^(?:input|select|textarea|button)$/i, sd = /^h\d$/i, lb = /^[^{]+\{\s*\[native \w/, gd = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, Qb = /[+~]/, hd = /'|\\/g, Fa = RegExp("\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)", "ig"), Ga = function (g, a, p) { g = "0x" + a - 65536; return g !== g || p ? a : 0 > g ? String.fromCharCode(g + 65536) : String.fromCharCode(g >> 10 | 55296, g & 1023 | 56320) }; try { Ea.apply(M = tc.call(X.childNodes), X.childNodes), M[X.childNodes.length].nodeType } catch (Zd) {
			Ea = {
				apply: M.length ? function (g, a) { nd.apply(g, tc.call(a)) } :
					function (g, a) { for (var p = g.length, b = 0; g[p++] = a[b++];); g.length = p - 1 }
			}
		} G = D.support = {}; rc = D.isXML = function (g) { return (g = g && (g.ownerDocument || g).documentElement) ? "HTML" !== g.nodeName : !1 }; ma = D.setDocument = function (g) {
			var a = g ? g.ownerDocument || g : X; g = a.defaultView; if (a === P || 9 !== a.nodeType || !a.documentElement) return P; P = a; ha = a.documentElement; Y = !rc(a); g && g !== g.top && (g.addEventListener ? g.addEventListener("unload", function () { ma() }, !1) : g.attachEvent && g.attachEvent("onunload", function () { ma() })); G.attributes = na(function (g) {
				g.className =
				"i"; return !g.getAttribute("className")
			}); G.getElementsByTagName = na(function (g) { g.appendChild(a.createComment("")); return !g.getElementsByTagName("*").length }); G.getElementsByClassName = lb.test(a.getElementsByClassName) && na(function (g) { g.innerHTML = "<div class='a'></div><div class='a i'></div>"; g.firstChild.className = "i"; return 2 === g.getElementsByClassName("i").length }); G.getById = na(function (g) { ha.appendChild(g).id = I; return !a.getElementsByName || !a.getElementsByName(I).length }); G.getById ? (F.find.ID = function (g,
				a) { if (typeof a.getElementById !== ga && Y) { var b = a.getElementById(g); return b && b.parentNode ? [b] : [] } }, F.filter.ID = function (g) { var a = g.replace(Fa, Ga); return function (g) { return g.getAttribute("id") === a } }) : (delete F.find.ID, F.filter.ID = function (g) { var a = g.replace(Fa, Ga); return function (g) { return (g = typeof g.getAttributeNode !== ga && g.getAttributeNode("id")) && g.value === a } }); F.find.TAG = G.getElementsByTagName ? function (g, a) { if (typeof a.getElementsByTagName !== ga) return a.getElementsByTagName(g) } : function (g, a) {
					var b,
					x = [], f = 0, c = a.getElementsByTagName(g); if ("*" === g) { for (; b = c[f++];)1 === b.nodeType && x.push(b); return x } return c
				}; F.find.CLASS = G.getElementsByClassName && function (g, a) { if (typeof a.getElementsByClassName !== ga && Y) return a.getElementsByClassName(g) }; pa = []; Q = []; if (G.qsa = lb.test(a.querySelectorAll)) na(function (g) {
				...
				}), na(function (g) { var b = a.createElement("input"); b.setAttribute("type", "hidden"); g.appendChild(b).setAttribute("name", "D"); g.querySelectorAll("[name=d]").length && Q.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?="); g.querySelectorAll(":enabled").length || Q.push(":enabled", ":disabled"); g.querySelectorAll("*,:x"); Q.push(",.*:") }); (G.matchesSelector = lb.test(Ja = ha.webkitMatchesSelector || ha.mozMatchesSelector || ha.oMatchesSelector || ha.msMatchesSelector)) &&
					na(function (g) { G.disconnectedMatch = Ja.call(g, "div"); Ja.call(g, "[s!='']:x"); pa.push("!=", Xb) }); Q = Q.length && RegExp(Q.join("|")); pa = pa.length && RegExp(pa.join("|")); ra = (g = lb.test(ha.compareDocumentPosition)) || lb.test(ha.contains) ? function (g, a) { var b = 9 === g.nodeType ? g.documentElement : g, x = a && a.parentNode; return g === x || !(!x || !(1 === x.nodeType && (b.contains ? b.contains(x) : g.compareDocumentPosition && g.compareDocumentPosition(x) & 16))) } : function (g, a) { if (a) for (; a = a.parentNode;)if (a === g) return !0; return !1 }; A = g ? function (g,
						b) { if (g === b) return Aa = !0, 0; var f = !g.compareDocumentPosition - !b.compareDocumentPosition; if (f) return f; f = (g.ownerDocument || g) === (b.ownerDocument || b) ? g.compareDocumentPosition(b) : 1; return f & 1 || !G.sortDetached && b.compareDocumentPosition(g) === f ? g === a || g.ownerDocument === X && ra(X, g) ? -1 : b === a || b.ownerDocument === X && ra(X, b) ? 1 : oa ? Ta.call(oa, g) - Ta.call(oa, b) : 0 : f & 4 ? -1 : 1 } : function (g, b) {
							if (g === b) return Aa = !0, 0; var f, c = 0; f = g.parentNode; var k = b.parentNode, d = [g], n = [b]; if (!f || !k) return g === a ? -1 : b === a ? 1 : f ? -1 : k ? 1 : oa ? Ta.call(oa,
								g) - Ta.call(oa, b) : 0; if (f === k) return pc(g, b); for (f = g; f = f.parentNode;)d.unshift(f); for (f = b; f = f.parentNode;)n.unshift(f); for (; d[c] === n[c];)c++; return c ? pc(d[c], n[c]) : d[c] === X ? -1 : n[c] === X ? 1 : 0
						}; return a
		}; D.matches = function (g, a) { return D(g, null, null, a) }; D.matchesSelector = function (g, a) {
			(g.ownerDocument || g) !== P && ma(g); a = a.replace(od, "='$1']"); if (G.matchesSelector && Y && (!pa || !pa.test(a)) && (!Q || !Q.test(a))) try { var b = Ja.call(g, a); if (b || G.disconnectedMatch || g.document && 11 !== g.document.nodeType) return b } catch (f) { } return 0 <
				D(a, P, null, [g]).length
		}; D.contains = function (g, a) { (g.ownerDocument || g) !== P && ma(g); return ra(g, a) }; D.attr = function (g, a) { (g.ownerDocument || g) !== P && ma(g); var b = F.attrHandle[a.toLowerCase()], b = b && da.call(F.attrHandle, a.toLowerCase()) ? b(g, a, !Y) : void 0; return void 0 !== b ? b : G.attributes || !Y ? g.getAttribute(a) : (b = g.getAttributeNode(a)) && b.specified ? b.value : null }; D.error = function (g) { throw Error("Syntax error, unrecognized expression: " + g); }; D.uniqueSort = function (g) {
			var a, b = [], f = 0, c = 0; Aa = !G.detectDuplicates; oa =
				!G.sortStable && g.slice(0); g.sort(A); if (Aa) { for (; a = g[c++];)a === g[c] && (f = b.push(c)); for (; f--;)g.splice(b[f], 1) } oa = null; return g
			...
			cacheLength: 50, createPseudo: R, match: xb, attrHandle: {}, find: {}, relative: {
				...
				TAG: function (g) { var a = g.replace(Fa, Ga).toLowerCase(); return "*" === g ? function () { return !0 } : function (g) { return g.nodeName && g.nodeName.toLowerCase() === a } }, CLASS: function (g) {
					var a = sc[g + " "]; return a || (a = RegExp("(^|[\\x20\\t\\r\\n\\f])" + g + "([\\x20\\t\\r\\n\\f]|$)")) && sc(g, function (g) {
						return a.test("string" === typeof g.className &&
							g.className || typeof g.getAttribute !== ga && g.getAttribute("class") || "")
					})
					...
					var k = "nth" !== g.slice(0, 3), d = "last" !== g.slice(-4), n = "of-type" === a; return 1 === f && 0 === c ? function (g) { return !!g.parentNode } :
						function (a, b, p) {
							var x, e, r, h, q; b = k !== d ? "nextSibling" : "previousSibling"; var j = a.parentNode, l = n && a.nodeName.toLowerCase(); p = !p && !n; if (j) {
								if (k) { for (; b;) { for (e = a; e = e[b];)if (n ? e.nodeName.toLowerCase() === l : 1 === e.nodeType) return !1; q = b = "only" === g && !q && "nextSibling" } return !0 } q = [d ? j.firstChild : j.lastChild]; if (d && p) { p = j[I] || (j[I] = {}); x = p[g] || []; h = x[0] === ca && x[1]; r = x[0] === ca && x[2]; for (e = h && j.childNodes[h]; e = ++h && e && e[b] || (r = h = 0) || q.pop();)if (1 === e.nodeType && ++r && e === a) { p[g] = [ca, h, r]; break } } else if (p && (x = (a[I] ||
									(a[I] = {}))[g]) && x[0] === ca) r = x[1]; else for (; e = ++h && e && e[b] || (r = h = 0) || q.pop();)if ((n ? e.nodeName.toLowerCase() === l : 1 === e.nodeType) && ++r) if (p && ((e[I] || (e[I] = {}))[g] = [ca, r]), e === a) break; r -= c; return r === f || 0 === r % f && 0 <= r / f
							}
						}
				}, PSEUDO: function (g, a) {
				...
				not: R(function (g) { var a = [], b = [], f = $a(g.replace(wb, "$1")); return f[I] ? R(function (g, a, b, p) { p = f(g, null, p, []); for (var x = g.length; x--;)if (b = p[x]) g[x] = !(a[x] = b) }) : function (g, c, k) { a[0] = g; f(a, null, k, b); return !b.pop() } }), has: R(function (g) { return function (a) { return 0 < D(g, a).length } }), contains: R(function (g) { return function (a) { return -1 < (a.textContent || a.innerText || Ia(a)).indexOf(g) } }), lang: R(function (g) {
					qd.test(g || "") || D.error("unsupported lang: " + g); g = g.replace(Fa,
						Ga).toLowerCase(); return function (a) { var b; do if (b = Y ? a.lang : a.getAttribute("xml:lang") || a.getAttribute("lang")) return b = b.toLowerCase(), b === g || 0 === b.indexOf(g + "-"); while ((a = a.parentNode) && 1 === a.nodeType); return !1 }
				}), target: function (g) { var a = Pb.location && Pb.location.hash; return a && a.slice(1) === g.id }, root: function (g) { return g === ha }, focus: function (g) { return g === P.activeElement && (!P.hasFocus || P.hasFocus()) && !(!g.type && !g.href && !~g.tabIndex) }, enabled: function (g) { return !1 === g.disabled }, disabled: function (g) {
					return !0 ===
						g.disabled
			...
			var b, f = [], c = [], k = Ba[g + " "]; if (!k) {
				a || (a = sa(g)); for (b = a.length; b--;)k = Wb(a[b]), k[I] ? f.push(k) : c.push(k); var d = 0 < f.length, n = 0 < c.length; b = function (g, a, b, p, k) {
					var x, e, r, h = 0, q = "0", j = g && [], qa = [], l = ya, A = g || n && F.find.TAG("*",
						k), z = ca += null == l ? 1 : Math.random() || 0.1, t = A.length; for (k && (ya = a !== P && a); q !== t && null != (x = A[q]); q++) { if (n && x) { for (e = 0; r = c[e++];)if (r(x, a, b)) { p.push(x); break } k && (ca = z) } d && ((x = !r && x) && h--, g && j.push(x)) } h += q; if (d && q !== h) { for (e = 0; r = f[e++];)r(j, qa, a, b); if (g) { if (0 < h) for (; q--;)!j[q] && !qa[q] && (qa[q] = Z.call(p)); qa = Sa(qa) } Ea.apply(p, qa); k && (!g && 0 < qa.length && 1 < h + f.length) && D.uniqueSort(p) } k && (ca = z, ya = l); return j
				}; b = d ? R(b) : b; k = Ba(g, b)
			} return k
		}; G.sortStable = I.split("").sort(A).join("") === I; G.detectDuplicates = !!Aa;
	ma(); G.sortDetached = na(function (g) { return g.compareDocumentPosition(P.createElement("div")) & 1 }); na(function (g) { g.innerHTML = "<a href='#'></a>"; return "#" === g.firstChild.getAttribute("href") }) || Sb("type|href|height|width", function (g, a, b) { if (!b) return g.getAttribute(a, "type" === a.toLowerCase() ? 1 : 2) }); (!G.attributes || !na(function (g) { g.innerHTML = "<input/>"; g.firstChild.setAttribute("value", ""); return "" === g.firstChild.getAttribute("value") })) && Sb("value", function (g, a, b) { if (!b && "input" === g.nodeName.toLowerCase()) return g.defaultValue });
	na(function (g) { return null == g.getAttribute("disabled") }) || Sb("checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", function (g, a, b) { var f; if (!b) return !0 === g[a] ? a.toLowerCase() : (f = g.getAttributeNode(a)) && f.specified ? f.value : null }); f.find = D; f.expr = D.selectors; f.expr[":"] = f.expr.pseudos; f.unique = D.uniqueSort; f.text = D.getText; f.isXMLDoc = D.isXML; f.contains = D.contains; var wc = f.expr.match.needsContext, xc = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Vc =
		/^.[^:#\[\.,]*$/; f.filter = function (g, a, b) { var c = a[0]; b && (g = ":not(" + g + ")"); return 1 === a.length && 1 === c.nodeType ? f.find.matchesSelector(c, g) ? [c] : [] : f.find.matches(g, f.grep(a, function (g) { return 1 === g.nodeType })) }; f.fn.extend({
					...
					state: function () { return b }, always: function () { k.done(arguments).fail(arguments); return this }, then: function () {
						var g = arguments; return f.Deferred(function (b) {
							f.each(a, function (a, p) {
								var x = f.isFunction(g[a]) && g[a]; k[p[1]](function () {
									var g = x && x.apply(this, arguments); if (g && f.isFunction(g.promise)) g.promise().done(b.resolve).fail(b.reject).progress(b.notify); else b[p[0] + "With"](this === c ? b.promise() :
										this, x ? [g] : arguments)
								})
							}); g = null
						}).promise()
		...
		}; var ja = "undefined", zc; for (zc in f(v)) break; v.ownLast = "0" !== zc; v.inlineBlockNeedsLayout = !1; f(function () {
			var g, a, b = y.getElementsByTagName("body")[0]; if (b) {
				g = y.createElement("div"); g.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px"; a = y.createElement("div"); b.appendChild(g).appendChild(a); if (typeof a.style.zoom !== ja && (a.style.cssText =
			...
			queue: function (g, a, b) { var c; if (g) return a = (a || "fx") + "queue", c = f._data(g, a), b && (!c || f.isArray(b) ? c = f._data(g, a, f.makeArray(b)) : c.push(b)), c || [] }, dequeue: function (a,
				b) { b = b || "fx"; var c = f.queue(a, b), k = c.length, d = c.shift(), n = f._queueHooks(a, b), e = function () { f.dequeue(a, b) }; "inprogress" === d && (d = c.shift(), k--); d && ("fx" === b && c.unshift("inprogress"), delete n.stop, d.call(a, e, n)); !k && n && n.empty.fire() }, _queueHooks: function (a, b) { var c = b + "queueHooks"; return f._data(a, c) || f._data(a, c, { empty: f.Callbacks("once memory").add(function () { f._removeData(a, b + "queue"); f._removeData(a, c) }) }) }
		}); f.fn.extend({
			queue: function (a, b) {
	...
	nb.checked = !0; Yb.appendChild(nb); v.appendChecked = nb.checked; aa.innerHTML = "<textarea>x</textarea>"; v.noCloneChecked = !!aa.cloneNode(!0).lastChild.defaultValue; Yb.appendChild(aa); aa.innerHTML = "<input type='radio' checked='checked' name='t'/>"; v.checkClone = aa.cloneNode(!0).cloneNode(!0).lastChild.checked; v.noCloneEvent = !0; aa.attachEvent && (aa.attachEvent("onclick", function () { v.noCloneEvent = !1 }), aa.cloneNode(!0).click()); if (null == v.deleteExpando) {
		v.deleteExpando = !0; try { delete aa.test } catch (ae) {
			v.deleteExpando =
			!1
		}
	} var Yb = aa = nb = null, Ab, Bb, Ac = y.createElement("div"); for (Ab in { submit: !0, change: !0, focusin: !0 }) if (Bb = "on" + Ab, !(v[Ab + "Bubbles"] = Bb in a)) Ac.setAttribute(Bb, "t"), v[Ab + "Bubbles"] = !1 === Ac.attributes[Bb].expando; var Zb = /^(?:input|select|textarea)$/i, xd = /^key/, yd = /^(?:mouse|contextmenu)|click/, Bc = /^(?:focusinfocus|focusoutblur)$/, Cc = /^([^.]*)(?:\.(.+)|)$/; f.event = {
		global: {}, add: function (a, b, c, k, d) {
			var n, e, r, h, q, j, l, A, z; if (r = f._data(a)) {
				...
				if (!(e = r.events)) e = r.events = {}; if (!(q = r.handle)) q = r.handle = function (a) { return typeof f !== ja && (!a || f.event.triggered !== a.type) ? f.event.dispatch.apply(q.elem, arguments) : void 0 }, q.elem = a; b = (b || "").match(va) || [""]; for (r = b.length; r--;)if (n = Cc.exec(b[r]) || [], A = j = n[1], z = (n[2] || "").split(".").sort(), A) {
			...
			var n, e, r, h, q, j, l, A, z, t, ga, K = f.hasData(a) && f._data(a); if (K && (j = K.events)) {
				b = (b || "").match(va) || [""]; for (q = b.length; q--;)if (r = Cc.exec(b[q]) || [],
					z = ga = r[1], t = (r[2] || "").split(".").sort(), z) { l = f.event.special[z] || {}; z = (k ? l.delegateType : l.bindType) || z; A = j[z] || []; r = r[2] && RegExp("(^|\\.)" + t.join("\\.(?:.*\\.|)") + "(\\.|$)"); for (h = n = A.length; n--;)if (e = A[n], (d || ga === e.origType) && (!c || c.guid === e.guid) && (!r || r.test(e.namespace)) && (!k || k === e.selector || "**" === k && e.selector)) A.splice(n, 1), e.selector && A.delegateCount--, l.remove && l.remove.call(a, e); h && !A.length && ((!l.teardown || !1 === l.teardown.call(a, t, K.handle)) && f.removeEvent(a, z, K.handle), delete j[z]) } else for (z in j) f.event.remove(a,
		...
		a.removeEventListener && a.removeEventListener(b,
			f, !1)
	} : function (a, b, f) { b = "on" + b; a.detachEvent && (typeof a[b] === ja && (a[b] = null), a.detachEvent(b, f)) }; f.Event = function (a, b) { if (!(this instanceof f.Event)) return new f.Event(a, b); a && a.type ? (this.originalEvent = a, this.type = a.type, this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && (!1 === a.returnValue || a.getPreventDefault && a.getPreventDefault()) ? d : q) : this.type = a; b && f.extend(this, b); this.timeStamp = a && a.timeStamp || f.now(); this[f.expando] = !0 }; f.Event.prototype = {
		...
		Hc = /^$|\/(?:java|ecma)script/i, Yc = /^true\/(.*)/, Dd = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, ia = { option: [1, "<select multiple='multiple'>", "</select>"], legend: [1, "<fieldset>", "</fieldset>"], area: [1, "<map>", "</map>"], param: [1, "<object>", "</object>"], thead: [1, "<table>", "</table>"], tr: [2, "<table><tbody>", "</tbody></table>"], col: [2, "<table><tbody></tbody><colgroup>", "</colgroup></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], _default: v.htmlSerialize ? [0, "", ""] : [1, "X<div>", "</div>"] }, ac =
			T(y).appendChild(y.createElement("div")); ia.optgroup = ia.option; ia.tbody = ia.tfoot = ia.colgroup = ia.caption = ia.thead; ia.th = ia.td; f.extend({
				clone: function (a, b, c) {
						...
						k = C(n); r = C(a); for (e = 0; null != (d = r[e]); ++e)if (k[e]) {
							var q = k[e], l = void 0, j =
								void 0, A = void 0; if (1 === q.nodeType) {
									l = q.nodeName.toLowerCase(); if (!v.noCloneEvent && q[f.expando]) { A = f._data(q); for (j in A.events) f.removeEvent(q, j, A.handle); q.removeAttribute(f.expando) } if ("script" === l && q.text !== d.text) Ca(q).text = d.text, U(q); else if ("object" === l) q.parentNode && (q.outerHTML = d.outerHTML), v.html5Clone && (d.innerHTML && !f.trim(q.innerHTML)) && (q.innerHTML = d.innerHTML); else if ("input" === l && Mb.test(d.type)) q.defaultChecked = q.checked = d.checked, q.value !== d.value && (q.value = d.value); else if ("option" ===
					...
					for (var c, d, n, e, r = 0, h = f.expando, q = f.cache, l = v.deleteExpando, j = f.event.special; null != (c = a[r]); r++)if (b || f.acceptData(c)) if (e = (n = c[h]) && q[n]) {
						if (e.events) for (d in e.events) j[d] ? f.event.remove(c, d) : f.removeEvent(c, d, e.handle); q[n] && (delete q[n],
							l ? delete c[h] : typeof c.removeAttribute !== ja ? c.removeAttribute(h) : c[h] = null, k.push(n))
					}
				}
			}); f.fn.extend({
				text: function (a) { return Ua(this, function (a) { return void 0 === a ? f.text(this) : this.empty().append((this[0] && this[0].ownerDocument || y).createTextNode(a)) }, null, a, arguments.length) }, append: function () { return this.domManip(arguments, function (a) { (1 === this.nodeType || 11 === this.nodeType || 9 === this.nodeType) && Ya(this, a).appendChild(a) }) }, prepend: function () {
					...
					return Ua(this, function (a) {
						var g = this[0] || {}, b = 0, c = this.length; if (void 0 === a) return 1 === g.nodeType ? g.innerHTML.replace(zd,
							"") : void 0; if ("string" === typeof a && !Bd.test(a) && (v.htmlSerialize || !Dc.test(a)) && (v.leadingWhitespace || !$b.test(a)) && !ia[(Fc.exec(a) || ["", ""])[1].toLowerCase()]) { a = a.replace(Ec, "<$1></$2>"); try { for (; b < c; b++)g = this[b] || {}, 1 === g.nodeType && (f.cleanData(C(g, !1)), g.innerHTML = a); g = 0 } catch (k) { } } g && this.empty().append(a)
					...
					a = r.apply([], a); var c, k, d, n, e = 0, h = this.length, q = this, l = h - 1, j = a[0], A = f.isFunction(j); if (A || 1 < h && "string" === typeof j && !v.checkClone && Cd.test(j)) return this.each(function (c) { var f = q.eq(c); A && (a[0] = j.call(this, c, f.html())); f.domManip(a, b) }); if (h && (n = f.buildFragment(a, this[0].ownerDocument, !1, this), c = n.firstChild, 1 === n.childNodes.length && (n = c), c)) {
						d = f.map(C(n, "script"), Ca); for (k = d.length; e < h; e++)c = n, e !==
							l && (c = f.clone(c, !0, !0), k && f.merge(d, C(c, "script"))), b.call(this[e], c, e); if (k) { n = d[d.length - 1].ownerDocument; f.map(d, U); for (e = 0; e < k; e++)if (c = d[e], Hc.test(c.type || "") && !f._data(c, "globalEval") && f.contains(n, c)) c.src ? f._evalUrl && f._evalUrl(c.src) : f.globalEval((c.text || c.textContent || c.innerHTML || "").replace(Dd, "")) } n = c = null
					} return this
				}
				...
				ab.style.backgroundClip; ob = ab = null; v.shrinkWrapBlocks = function () {
					...
					bb = y.createElement("div"), bc = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px"; bb.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"; pb = bb.getElementsByTagName("a")[0]; pb.style.cssText = "float:left;opacity:.5"; v.opacity = /^0.5/.test(pb.style.opacity); v.cssFloat = !!pb.style.cssFloat; bb.style.backgroundClip = "content-box"; bb.cloneNode(!0).style.backgroundClip = ""; v.clearCloneStyle = "content-box" === bb.style.backgroundClip; pb = bb = null; f.extend(v, {
						...
						zb + ")(.*)$", "i"), Hd = RegExp("^([+-])=(" + zb + ")", "i"), Id = { position: "absolute", visibility: "hidden", display: "block" }, Jc = { letterSpacing: 0, fontWeight: 400 }, oc = ["Webkit", "O", "Moz", "ms"]; f.extend({
							...
							f.cssHooks[b] = {
								get: function (a, g, c) { if (g) return 0 === a.offsetWidth && Gd.test(f.css(a, "display")) ? f.swap(a, Id, function () { return V(a, b, c) }) : V(a, b, c) }, set: function (a,
									g, c) { var k = c && Pa(a); return ka(a, g, c ? w(a, b, c, v.boxSizing() && "border-box" === f.css(a, "boxSizing", !1, k), k) : 0) }
							}
			...
			Jb = v.input; f.fn.extend({ attr: function (a, b) { return Ua(this, f.attr, a, b, 1 < arguments.length) }, removeAttr: function (a) { return this.each(function () { f.removeAttr(this, a) }) } }); f.extend({
				attr: function (a, b, c) {
					var k, d, n = a.nodeType; if (a && !(3 === n || 8 === n || 2 === n)) {
						if (typeof a.getAttribute === ja) return f.prop(a, b, c); if (1 !== n || !f.isXMLDoc(a)) b = b.toLowerCase(), k = f.attrHooks[b] || (f.expr.match.bool.test(b) ? Lc : cb); if (void 0 !== c) if (null === c) f.removeAttr(a, b); else {
		...
		f.each(["href", "src"], function (a, b) { f.propHooks[b] = { get: function (a) { return a.getAttribute(b, 4) } } }); v.optSelected || (f.propHooks.selected = { get: function (a) { if (a = a.parentNode) a.selectedIndex, a.parentNode && a.parentNode.selectedIndex; return null } }); f.each("tabIndex readOnly maxLength cellSpacing cellPadding rowSpan colSpan useMap frameBorder contentEditable".split(" "), function () { f.propFix[this.toLowerCase()] = this }); v.enctype || (f.propFix.enctype = "encoding"); var ic = /[\t\r\n\f]/g; f.fn.extend({
			addClass: function (a) {
				...
				var c = typeof a; return "boolean" === typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : f.isFunction(a) ? this.each(function (c) { f(this).toggleClass(a.call(this, c, this.className, b), b) }) :
					this.each(function () { if ("string" === c) for (var b, k = 0, d = f(this), n = a.match(va) || []; b = n[k++];)d.hasClass(b) ? d.removeClass(b) : d.addClass(b); else if (c === ja || "boolean" === c) this.className && f._data(this, "__className__", this.className), this.className = this.className || !1 === a ? "" : f._data(this, "__className__") || "" })
	...
	f.parseJSON = function (b) { if (a.JSON && a.JSON.parse) return a.JSON.parse(b + ""); var c, k = null, d = f.trim(b + ""); return d && !f.trim(d.replace(Od, function (a, b, g, f) { c && b && (k = 0); if (0 === k) return a; c = g || b; k += !f - !g; return "" })) ? Function("return " + d)() : f.error("Invalid JSON: " + b) }; f.parseXML = function (b) {
		...
		active: 0, lastModified: {}, etag: {}, ajaxSettings: {
			...
			function c(a, b, g, k) {
				var d, l, p, m; m = b; if (2 !== da) {
					da = 2; r && clearTimeout(r); q = void 0; e = k || ""; s.readyState = 0 < a ? 4 : 0; k = 200 <= a && 300 > a || 304 === a; if (g) {
						p = j; for (var M = s, S, x, E, C, T = p.contents, N = p.dataTypes; "*" === N[0];)N.shift(), void 0 === x && (x = p.mimeType || M.getResponseHeader("Content-Type")); if (x) for (C in T) if (T[C] && T[C].test(x)) { N.unshift(C); break } if (N[0] in g) E = N[0]; else {
							for (C in g) {
						...
						g = j; S = p; x = s; E = k; var v, Z, u, M = {}, T = g.dataTypes.slice(); if (T[1]) for (Z in g.converters) M[Z.toLowerCase()] = g.converters[Z]; for (C = T.shift(); C;)if (g.responseFields[C] && (x[g.responseFields[C]] = S), !u && (E && g.dataFilter) && (S = g.dataFilter(S, g.dataType)), u = C, C = T.shift()) if ("*" === C) C = u; else if ("*" !== u && u !== C) {
							Z = M[u + " " + C] || M["* " + C]; if (!Z) for (v in M) if (p = v.split(" "), p[1] === C && (Z = M[u + " " + p[0]] || M["* " + p[0]])) {
								!0 === Z ? Z = M[v] : !0 !== M[v] &&
									(C = p[0], T.unshift(p[1])); break
							} if (!0 !== Z) if (Z && g["throws"]) S = Z(S); else try { S = Z(S) } catch (Xa) { p = { state: "parsererror", error: Z ? Xa : "No conversion from " + u + " to " + C }; break a }
						} p = { state: "success", data: S }
					} if (k) j.ifModified && ((m = s.getResponseHeader("Last-Modified")) && (f.lastModified[n] = m), (m = s.getResponseHeader("etag")) && (f.etag[n] = m)), 204 === a || "HEAD" === j.type ? m = "nocontent" : 304 === a ? m = "notmodified" : (m = p.state, d = p.data, l = p.error, k = !l); else if (l = m, a || !m) m = "error", 0 > a && (a = 0); s.status = a; s.statusText = (b || m) + ""; k ?
						t.resolveWith(A, [d, m, s]) : t.rejectWith(A, [s, m, l]); s.statusCode(K); K = void 0; h && z.trigger(k ? "ajaxSuccess" : "ajaxError", [s, j, k ? d : l]); ga.fireWith(A, [s, m]); h && (z.trigger("ajaxComplete", [s, j]), --f.active || f.event.trigger("ajaxStop"))
				}
			} "object" === typeof a && (b = a, a = void 0); b = b || {}; var k, d, n, e, r, h, q, l, j = f.ajaxSetup({}, b), A = j.context || j, z = j.context && (A.nodeType || A.jquery) ? f(A) : f.event, t = f.Deferred(), ga = f.Callbacks("once memory"), K = j.statusCode || {}, m = {}, M = {}, da = 0, S = "canceled", s = {
				readyState: 0, getResponseHeader: function (a) {
					var b;
					if (2 === da) { if (!l) for (l = {}; b = Qd.exec(e);)l[b[1].toLowerCase()] = b[2]; b = l[a.toLowerCase()] } return null == b ? null : b
				}, getAllResponseHeaders: function () { return 2 === da ? e : null }, setRequestHeader: function (a, b) { var c = a.toLowerCase(); da || (a = M[c] = M[c] || a, m[a] = b); return this }, overrideMimeType: function (a) { da || (j.mimeType = a); return this }, statusCode: function (a) { var b; if (a) if (2 > da) for (b in a) K[b] = [K[b], a[b]]; else s.always(a[s.status]); return this }, abort: function (a) { a = a || S; q && q.abort(a); c(0, a); return this }
			}; t.promise(s).complete =
				ga.add; s.success = s.done; s.error = s.fail; j.url = ((a || j.url || Ma) + "").replace(Pd, "").replace(Sd, Wa[1] + "//"); j.type = b.method || b.type || j.method || j.type; j.dataTypes = f.trim(j.dataType || "*").toLowerCase().match(va) || [""]; null == j.crossDomain && (k = Nc.exec(j.url.toLowerCase()), j.crossDomain = !(!k || !(k[1] !== Wa[1] || k[2] !== Wa[2] || (k[3] || ("http:" === k[1] ? "80" : "443")) !== (Wa[3] || ("http:" === Wa[1] ? "80" : "443"))))); j.data && (j.processData && "string" !== typeof j.data) && (j.data = f.param(j.data, j.traditional)); ub(Oc, j, b, s); if (2 ===
					da) return s; (h = j.global) && 0 === f.active++ && f.event.trigger("ajaxStart"); j.type = j.type.toUpperCase(); j.hasContent = !Rd.test(j.type); n = j.url; j.hasContent || (j.data && (n = j.url += (kc.test(n) ? "&" : "?") + j.data, delete j.data), !1 === j.cache && (j.url = Mc.test(n) ? n.replace(Mc, "$1_=" + jc++) : n + (kc.test(n) ? "&" : "?") + "_=" + jc++)); j.ifModified && (f.lastModified[n] && s.setRequestHeader("If-Modified-Since", f.lastModified[n]), f.etag[n] && s.setRequestHeader("If-None-Match", f.etag[n])); (j.data && j.hasContent && !1 !== j.contentType || b.contentType) &&
						s.setRequestHeader("Content-Type", j.contentType); s.setRequestHeader("Accept", j.dataTypes[0] && j.accepts[j.dataTypes[0]] ? j.accepts[j.dataTypes[0]] + ("*" !== j.dataTypes[0] ? ", " + Pc + "; q=0.01" : "") : j.accepts["*"]); for (d in j.headers) s.setRequestHeader(d, j.headers[d]); if (j.beforeSend && (!1 === j.beforeSend.call(A, s, j) || 2 === da)) return s.abort(); S = "abort"; for (d in { success: 1, error: 1, complete: 1 }) s[d](j[d]); if (q = ub(Nb, j, b, s)) {
							s.readyState = 1; h && z.trigger("ajaxSend", [s, j]); j.async && 0 < j.timeout && (r = setTimeout(function () { s.abort("timeout") },
								j.timeout)); try { da = 1, q.send(m, c) } catch (E) { if (2 > da) c(-1, E); else throw E; }
		...
		var c, k = [], d = function (a, b) { b = f.isFunction(b) ? b() : null == b ? "" : b; k[k.length] = encodeURIComponent(a) + "=" + encodeURIComponent(b) }; void 0 === b && (b = f.ajaxSettings && f.ajaxSettings.traditional); if (f.isArray(a) || a.jquery && !f.isPlainObject(a)) f.each(a, function () {
			d(this.name,
				this.value)
		}); else for (c in a) la(c, a[c], b, d); return k.join("&").replace(Td, "+")
	}; f.fn.extend({
	...
	}); f.ajaxSettings.xhr = void 0 !== a.ActiveXObject ? function () { var b; if (!(b = !this.isLocal && /^(get|post|head|put|delete|options)$/i.test(this.type) && W())) a: { try { b = new a.ActiveXObject("Microsoft.XMLHTTP"); break a } catch (c) { } b = void 0 } return b } : W; f.ajaxSettings.xhr = void 0 === a.ActiveXObject ? B : function () {
		...
		function (a) { return f.grep(f.timers, function (b) { return a === b.elem }).length }; var Tc = a.document.documentElement; f.offset = {
			...
			offset: function (a) { if (arguments.length) return void 0 === a ? this : this.each(function (b) { f.offset.setOffset(this, a, b) }); var b, c, k = { top: 0, left: 0 }, d = (c = this[0]) && c.ownerDocument; if (d) { b = d.documentElement; if (!f.contains(b, c)) return k; typeof c.getBoundingClientRect !== ja && (k = c.getBoundingClientRect()); c = ba(d); return { top: k.top + (c.pageYOffset || b.scrollTop) - (b.clientTop || 0), left: k.left + (c.pageXOffset || b.scrollLeft) - (b.clientLeft || 0) } } }, position: function () {
				if (this[0]) {
					var a,
	...
	f.fn.andSelf = f.fn.addBack; "function" === typeof define && define.amd && define("jquery", [], function () { return f }); var Xd = a.jQuery, Yd = a.$; f.noConflict = function (b) { a.$ === f && (a.$ = Yd); b && a.jQuery === f && (a.jQuery = Xd); return f }; typeof m === ja && (a.jQuery = a.$ = f); return f
});
(function (a) {
...
(function (a, m) {
	a.clazzAlert = function () { }; a.__$ = m; m(document).ready(function () { a._document = null }); a.$ = function (a, c) { null == a && alert(c + arguments.callee.caller.toString()); return m(c ? "#" + a._id + "_" + c : a) }; a._$ = function (a) { return "string" == typeof a ? m("#" + a) : a }; a.$ajax = function (b) { a._ajaxCall = b.url; b.cache = "NO" != b.cache; b.url = a._fixProtocol(b.url); return m.ajax(b) }; a._fixProtocol = function (b) {
		0 <= b.indexOf("get3d=True") && (b = b.replace(/get3d\=True/, "get3d=true")); return 0 == b.indexOf("http://www.rcsb.org/pdb/files/") &&
			0 > b.indexOf("/ligand/") ? "http://files.rcsb.org/view/" + b.substring(30).replace(/\.gz/, "") : 0 == b.indexOf("http://") && ("https://" == a._httpProto || 0 < b.indexOf(".gov/") || 0 == b.indexOf("http://www.materialsproject")) ? "https" + b.substring(4) : b
	}; a._getNCIInfo = function (b, c) { return a._getFileData("https://cactus.nci.nih.gov/chemical/structure/" + b + "/" + ("name" == c ? "names" : c)) }; a.$appEvent = function (b, c, d, e) { b = a.$(b, c); b.off(d) && e && b.on(d, e) }; a.$resize = function (a) { return m(window).resize(a) }; a.$after = function (a, c) { return m(a).after(c) };
	a.$append = function (a, c) { return m(a).append(c) }; a.$bind = function (a, c, d) { return d ? m(a).bind(c, d) : m(a).unbind(c) }; a.$closest = function (a, c) { return m(a).closest(c) }; a.$get = function (a, c) { return m(a).get(c) }; a.$documentOff = function (a, c) { return m(document).off(a, "#" + c) }; a.$documentOn = function (a, c, d) { return m(document).on(a, "#" + c, d) }; a.$getAncestorDiv = function (a, c) { return m("div." + c + ":has(#" + a + ")")[0] }; a.$supportsIECrossDomainScripting = function () { return m.support.iecors }; a.$attr = function (b, c, d) {
		return a._$(b).attr(c,
			d)
...
Jmol._debugCode = document && document.location && 0 <= document.location.href.indexOf("j2sdebugcode");
(function (a) {
	...
	a._jsSetPrototype = function (b) {
		...
		b.__startAppletJS = function (b) {
			...
			a._syncedApplets.length && c.put("synccallback", "Jmol._mySyncCallback"); c.put("signedApplet", "true"); c.put("platform", b._platform); b._is2D && c.put("display", b._id + "_canvas2d"); c.put("documentBase", document.location.href); var e = b._j2sPath + "/"; if (0 > e.indexOf("://")) { var j = document.location.href.split("#")[0].split("?")[0].split("/"); 0 == e.indexOf("/") ? j = [j[0], e.substring(1)] : j[j.length - 1] = e; e = j.join("/") } b._j2sFullPath = e.substring(0, e.length - 1); c.put("codePath", e); a._registerApplet(b._id, b); try { b._newApplet(c) } catch (h) {
				b =
				(a._isAsync ? "normal async abort? from " : "") + h; a._debugCode && alert(b); System.out.println(b); return
			} b._jsSetScreenDimensions(); s()
		}; b._restoreState || (b._restoreState = function () { }); b._jsSetScreenDimensions = function () { if (this._appletPanel) { var b = a._getElement(this, this._is2D ? "canvas2d" : "canvas"); this._appletPanel.setScreenDimension(b.width, b.height) } }; b._show = function (b) { a.$setVisible(a.$(this, "appletdiv"), b); b && a.repaint(this, !0) }; b._canScript = function () { return !0 }; b.equals = function (a) { return this == a };
		b.clone = function () { return this }; b.hashCode = function () { return parseInt(this._uniqueId) }; b._processGesture = function (a) { return this._appletPanel.processTwoPointGesture(a) }; b._processEvent = function (a, b) { this._appletPanel.processMouseEvent(a, b[0], b[1], b[2], System.currentTimeMillis()) }; b._processKeyEvent = function (a, b, c) { this._appletPanel.processKeyEvent({ getID: function () { return a }, getKeyCode: function () { return c.keyCode }, getModifiers: function () { return b[2] }, consume: function () { } }) }; b._resize = function () {
			var b =
				"__resizeTimeout_" + this._id; a[b] && clearTimeout(a[b]); var c = this; a[b] = setTimeout(function () { a.repaint(c, !0); a[b] = null }, 100)
		}; return b
	}; a.repaint = function (b, e) {
		if (b && b._appletPanel) {
			var j = a.$(b, "appletdiv"), h = Math.round(j.width()), j = Math.round(j.height()); if (b._is2D && (b._canvas.width != h || b._canvas.height != j)) b._newCanvas(!0), b._appletPanel.setDisplay(b._canvas); b._appletPanel.setScreenDimension(h, j); h = function () { b._appletPanel.paint ? b._appletPanel.paint(null) : b._appletPanel.update(null) }; e ? requestAnimationFrame(h) :
				h()
		}
	}; a.loadImage = function (b, e, j, h, l, t) {
		var m = "echo_" + e + j + (h ? "_" + h.length : ""), s = a.getHiddenCanvas(b.vwr.html5Applet, m, 0, 0, !1, !0); if (null == s) {
			if (null == t) { t = new Image; if (null == h) return t.onload = function () { a.loadImage(b, e, j, null, l, t) }, t.src = j, null; System.out.println("Jsmol.js Jmol.loadImage using data URI for " + m); t.src = "string" == typeof h ? h : "data:" + JU.Rdr.guessMimeTypeForBytes(h) + ";base64," + JU.Base64.getBase64(h) } var u = t.width, U = t.height; "webgl" == e && (u /= 2, U /= 2); s = a.getHiddenCanvas(b.vwr.html5Applet,
				m, u, U, !0, !1); s.imageWidth = u; s.imageHeight = U; s.id = m; s.image = t; a.setCanvasImage(s, u, U)
		} else System.out.println("Jsmol.js Jmol.loadImage reading cached image for " + m); return null == h ? l(s, j) : s
	}; a._canvasCache = {}; a.getHiddenCanvas = function (b, e, j, h, l, t) { e = b._id + "_" + e; b = a._canvasCache[e]; if (t) return b; if (l || !b || b.width != j || b.height != h) b = document.createElement("canvas"), b.width = b.style.width = j, b.height = b.style.height = h, b.id = e, a._canvasCache[e] = b; return b }; a.setCanvasImage = function (a, b, e) {
		a.buf32 = null; a.width =
			b; a.height = e; a.getContext("2d").drawImage(a.image, 0, 0, a.image.width, a.image.height, 0, 0, b, e)
	}; a.applyFunc = function (a, b) { return a(b) }
})(Jmol);
(function (a, m) {
	a._Applet = function (e, j, h) {
		window[e] = this; this._jmolType = "Jmol._Applet" + (j.isSigned ? " (signed)" : ""); this._viewType = "Jmol"; this._isJava = !0; this._syncKeyword = "Select:"; this._availableParams = ";progressbar;progresscolor;boxbgcolor;boxfgcolor;allowjavascript;boxmessage;\t\t\t;animframecallback;appletreadycallback;atommovedcallback;audiocallback;\t\t\t;clickcallback;dragdropcallback;echocallback;errorcallback;evalcallback;hovercallback;\t\t\t;imagecallback;loadstructcallback;measurecallback;messagecallback;minimizationcallback;modelkitcallback;pickcallback;\t\t\t;resizecallback;scriptcallback;selectcallback;servicecallback;structuremodifiedcallback;synccallback;\t\t\t;statusform;statustext;statustextarea;usecommandthread;syncid;appletid;startupscript;language;menufile;"; if (h) return this;
		this._isSigned = j.isSigned; this._readyFunction = j.readyFunction; this._ready = !1; this._isJava = !0; this._isInfoVisible = !1; this._applet = null; this._memoryLimit = j.memoryLimit || 512; this._canScript = function () { return !0 }; this._savedOrientations = []; this._initialize = function (e, h) {
	...
	}; h._show2d = function (a) { this._2dapplet._show2d(a); this._2dapplet._isEmbedded && (this._showInfo(!1), this._show(!a), this._2dapplet.__showContainer(!0, !0)) }; h._getSpinner = function () { return this.__Info.appletLoadingImage || this._j2sPath + "/img/JSmol_spinner.gif" }; h._getAtomCorrelation = function (a, j) {
...
LoadClazz = function () {
	TypeError.prototype.printStackTrace = ReferenceError.prototype.printStackTrace = function () { console.log(this) }; window["j2s.clazzloaded"] || (window["j2s.clazzloaded"] = !1); window["j2s.clazzloaded"] || (window["j2s.clazzloaded"] = !0, window["j2s.object.native"] = !0, Clazz = { _isQuiet: !1, _debugging: !1 }, function (a, m) {
		...
		a.allClasses = {}; a.isClassDefined = a.isDefinedClass = function (b) { if (!b) return !1; var c = a._getDeclared(b); if (!c) { for (var d = b.split(/\./), c = null, e = 0; e < d.length; e++)if (!(c = c ? c[d[e]] : a.allPackage[d[0]])) return !1; a._setDeclared(b, c) } return c }; a._setDeclared = function (b, c) { a.allClasses[b] = c; 0 > b.indexOf(".") && (a.allClasses["java.lang." + b] = c) }; a._getDeclared = function (b) { var c = a.allClasses[b]; !c && 0 > b.indexOf(".") && (c = a.allClasses["java.lang." + b]); return c }; a.instanceOf = function (b, c) {
			if (null == b) return !1; "string" ==
				typeof c && (c = a.isClassDefined(c)); return !c ? !1 : c == String ? "string" == typeof b : null != b && c && (b == c || b instanceof c || 0 <= a.getInheritedLevel(a.getClassName(b), c))
			...
			var h = null, j = -1, l = b[d]; if (l) if (l.claxxOwner) l.claxxOwner !== c && (h = l); else if (!l.stacks && (!l.lastClaxxRef || !l.lastClaxxRef.prototype[d] || !l.lastClaxxRef.prototype[d].stacks)) h = l; else {
				var m = l.stacks; m || (m = l.lastClaxxRef.prototype[d].stacks); for (j = m.length; 0 <= --j;)if (c === m[j]) {
					h = 0 < j ? m[--j].prototype[d] : m[0].prototype[d]["\\unknown"];
					break
				} else if (0 < a.getInheritedLevel(c, m[j])) { h = m[j].prototype[d]; break }
			...
			this.clazzName = b ? b instanceof String ? b : b instanceof Function ? a.getClassName(b,
				!0) : "" + b : "Object"; this.toString = function () { return null }; this.valueOf = function () { return null }
			...
			if (j = function (a, b, c) { c || (c = "[^\\s]+"); var d = a.indexOf(b); a = a.substring(0, d) + c + a.substring(d + b.length); return RegExp("^" + a + "$") }, /Opera[\/\s](\d+\.\d+)/.test(navigator.userAgent)) {
				...
				q = d.message.indexOf(":", j + 2), K = d.message.substr(j + 1, q - j - 20); c = function (a) { return -1 != a.message.indexOf(K) }
			} else if (-1 != navigator.userAgent.toLowerCase().indexOf("webkit")) { var T = j(d.message, "hello"); c = function (a) { return T.test(a.message) } } else T = j(d.message, "$$o$$"), c = function (a) { return T.test(a.message) }
		} a.exceptionOf = function (b, d) {
			if (b.__CLASS_NAME__) return a.instanceOf(b, d); b.getMessage || (b.getMessage = function () { return "" + b + (b.stack ? "\n" + b.stack : "") }); b.printStackTrace || (b.printStackTrace = function () {
				System.err.println("" +
					b)
			}); if (d == Error) { if (0 > ("" + b).indexOf("Error")) return !1; System.out.println(a.getStackTrace()); return !0 } return d == Exception || d == Throwable || d == NullPointerException && c(b)
			...
			h.exName = d; j = Ca(j);
			var l = c.prototype, m = l[d]; a._Loader._checkLoad && C(c, d, j); if (!m || m.claxxOwner === c && m.funParams == j) return h.funParams = j, h.claxxOwner = c, h.exClazz = c, l[d] = h; var s = null, q = m.stacks; q || (q = [], s = m, m.claxxOwner && (q[0] = s.claxxOwner)); if (!m.stacks || m.claxxReference !== c) {
				++O; m = function () {
					var c; a: {
						var d = arguments.callee.claxxReference, k = arguments.callee.methodName; c = arguments; fx = this[k]; var h = a.getParamsType(c); if (!fx) try { System.out.println(a.getStackTrace(5)) } catch (n) { } if (e) {
							var j = d.__CLASS_NAME__ + " " + k + " "; 0 > U.indexOf(j) &&
								(U += j + "\n"); e[j] || (e[j] = 0); e[j]++
							...
							fx.lastParams = h.typeString; fx.lastClaxxRef = d; j = fx.stacks; j || (j = d.prototype[k].stacks); for (var r = !1, l = j.length; 0 <= --l;)if (r || j[l] === d) {
								var m = j[l].prototype[k], z = h, r = c, s = fx, q = [], t = !0, E = void 0; for (E in m) if (92 == E.charCodeAt(0)) {
									...
									E = void 0; for (var E = [], N = q.length, u = 0; u < N; u++) { for (var w = [], xa = !0, C = q[u].length, B = 0; B < C; B++)if (w[B] = a.getInheritedLevel(z[B], q[u][B]), 0 > w[B]) { xa = !1; break } xa && (w[z.length] = u, E.push(w)) } if (0 == E.length) E = null; else { N = E[0]; for (u = 1; u < E.length; u++) { w = !0; for (B = 0; B < z.length; B++)if (N[B] < E[u][B]) { w = !1; break } w && (N = E[u]) } E = q[N[z.length]].join("\\") } E =
										!(q = E)
		...
		var rb = function (a, b) { if (a && b) for (var c = a.length; 0 <= --c;)if (a[c] === b) return c; return -1 }, Ya = function (a, b) { var c = rb(a, b); if (0 <= c) { for (var d = a.length - 1; c < d; c++)a[c] = a[c + 1]; a.length--; return !0 } }, Ca = function (a) { return a ? a.replace(/~([NABSO])/g, function (a, b) { switch (b) { case "N": return "n"; case "B": return "b"; case "S": return "String"; case "O": return "Object"; case "A": return "Array" }return "Unknown" }).replace(/\s+/g, "").replace(/^|,/g, "\\").replace(/\$/g, "org.eclipse.s") : "\\void" }; a.overrideMethod = function (b, c, d,
			...
			}; var O = 0; a.allPackage = {}; a.lastPackageName = null; a.lastPackage = null; a.unloadedClasses = []; a.declarePackage = function (b) {
				if (a.lastPackageName == b) return a.lastPackage; if (b && b.length) {
					for (var c = b.split(/\./), d = a.allPackage, e = 0; e < c.length; e++)d[c[e]] || (d[c[e]] = { __PKG_NAME__: d.__PKG_NAME__ ? d.__PKG_NAME__ + "." + c[e] : c[e] }, 0 ==
						e && a.setGlobal(c[e], d[c[e]])), d = d[c[e]]; a.lastPackageName = b; return a.lastPackage = d
				}
			}; a.evalType = function (b, c) { var d = b.lastIndexOf("."); if (-1 != d) { var e = b.substring(0, d), e = a.declarePackage(e), d = b.substring(d + 1); return e[d] } if (c) return window[b]; switch (b) { case "string": return String; case "number": return Number; case "object": return a._O; case "boolean": return Boolean; case "function": return Function; case "void": case "undefined": case "unknown": return b; case "NullObject": return NullObject; default: return window[b] } };
		a.defineType = function (b, c, d, e) { var h = a.unloadedClasses[b]; h && (c = h); h = b.lastIndexOf("."); if (-1 != h) { var j = b.substring(0, h), j = a.declarePackage(j), h = b.substring(h + 1); if (j[h]) return j[h]; j[h] = c } else { if (window[b]) return window[b]; a.setGlobal(b, c) } a.decorateAsType(c, b, d, e); b = a._innerFunctions; c.defineMethod = b.defineMethod; c.defineStaticMethod = b.defineStaticMethod; c.makeConstructor = b.makeConstructor; return c }; var Da = !1; -1 != navigator.userAgent.indexOf("Safari") && (j = navigator.userAgent, q = j.indexOf("Version/"),
			-1 != q && (j = j.substring(q + 8), Da = 4 <= parseFloat(j))); a.instantialize = function (a, b) {
				if (!b || !(1 == b.length && b[0] && b[0] instanceof s)) {
					a instanceof Number && (a.valueOf = function () { return this }); if (Da) { for (var c = [], d = 0; d < b.length; d++)c[d] = b[d]; b = c } (c = a.construct) ? a.con$truct ? a.getClass().superClazz ? c.claxxOwner && c.claxxOwner === a.getClass() || c.stacks && c.stacks[c.stacks.length - 1] == a.getClass() ? c.apply(a, b) : (c.claxxOwner && !c.claxxOwner.superClazz && c.claxxOwner.con$truct ? c.claxxOwner.con$truct.apply(a, []) : c.stacks &&
						(1 == c.stacks.length && !c.stacks[0].superClazz) && c.stacks[0].con$truct.apply(a, []), c.apply(a, b), a.con$truct.apply(a, [])) : (a.con$truct.apply(a, []), c.apply(a, b)) : c.apply(a, b) : a.con$truct && a.con$truct.apply(a, [])
				}
				...
				isInstance: function (b) { return a.instanceOf(b, this) }, equals: function (a) { return this === a }, hashCode: function () { return this.getName().hashCode() },
				toString: function () { return "class " + this.getName() }, getName: function () { return a.getClassName(this, !0) }, getCanonicalName: function () { return this.__CLASS_NAME__ }, getClassLoader: function () { var b = this.__CLASS_NAME__, c = a._Loader.getClasspathFor(b), d = c.lastIndexOf(b.replace(/\./g, "/")), c = -1 != d ? c.substring(0, d) : a._Loader.getClasspathFor(b, !0), b = a._Loader.requireLoaderByBase(c); b.getResourceAsStream = a._innerFunctions.getResourceAsStream; b.getResource = a._innerFunctions.getResource; return b }, getResource: function (a) {
					return (a =
						this.getResourceAsStream(a)) ? a.url : null
				}, getResourceAsStream: function (b) {
					if (!b) return null; b = b.replace(/\\/g, "/"); var c = null, d = b, d = this.__CLASS_NAME__; 2 == arguments.length && 0 != b.indexOf("/") && (b = "/" + b); if (0 == b.indexOf("/")) if (2 == arguments.length ? (c = arguments[1]) || (c = a.binaryFolders[0]) : a._Loader && (c = a._Loader.getClasspathFor(d, !0)), c) { var c = c.replace(/\\/g, "/"), e = c.length, e = c.charAt(e - 1); "/" != e && (c += "/"); d = c + b.substring(1) } else d = b.substring(1); else {
						if (this.base) c = this.base; else if (a._Loader) if (c =
							a._Loader.getClasspathFor(d), e = c.lastIndexOf(d.replace(/\./g, "/")), -1 != e) c = c.substring(0, e); else if (e = -1, c.indexOf(".z.js") == c.length - 5 && -1 != (e = c.lastIndexOf("/"))) for (var c = c.substring(0, e + 1), e = d.split(/\./), h = 1; h < e.length; h++) { for (var j = "/", l = 0; l < h; l++)j += e[l] + "/"; if (j.length > c.length) break; if (c.indexOf(j) == c.length - j.length) { c = c.substring(0, c.length - j.length + 1); break } } else c = a._Loader.getClasspathFor(d, !0); else (e = a.binaryFolders) && e.length && (c = e[0]); c || (c = "j2s/"); c = c.replace(/\\/g, "/"); e = c.length;
						e = c.charAt(e - 1); "/" != e && (c += "/"); this.base ? d = c + b : (e = d.lastIndexOf("."), d = -1 == e || this.base ? c + b : c + d.substring(0, e).replace(/\./g, "/") + "/" + b)
					} c = null; try { if (0 > d.indexOf(":/")) { var q = document.location.href.split("?")[0].split("/"); q[q.length - 1] = d; d = q.join("/") } c = new java.net.URL(d) } catch (s) { } q = null == c ? null : m._getFileData(d.toString()); if (!q || "error" == q || 0 == q.indexOf("[Exception")) return null; q = (new java.lang.String(q)).getBytes(); q = new java.io.BufferedInputStream(new java.io.ByteArrayInputStream(q)); q.url =
						c; return q
			...
			}; Number.prototype._numberToString = Number.prototype.toString; a.declarePackage("java.io"); a.declarePackage("java.lang.reflect"); a.declarePackage("java.lang.ref"); java.lang.ref.reflect = java.lang.reflect; a.declarePackage("java.util"); a.declarePackage("java.security"); a.declareInterface(java.io, "Closeable");
		a.declareInterface(java.io, "DataInput"); a.declareInterface(java.io, "DataOutput"); a.declareInterface(java.io, "Externalizable"); a.declareInterface(java.io, "Flushable"); a.declareInterface(java.io, "Serializable"); a.declareInterface(java.lang, "Appendable"); a.declareInterface(java.lang, "AutoCloseable"); a.declareInterface(java.lang, "CharSequence"); a.declareInterface(java.lang, "Cloneable"); a.declareInterface(java.lang, "Comparable"); a.declareInterface(java.lang, "Iterable"); a.declareInterface(java.lang, "Runnable");
		a.declareInterface(java.util, "Comparator"); java.lang.ClassLoader = { __CLASS_NAME__: "ClassLoader" }; var fb = function (b, c, d, e) { b = ""; e && (b = e.substring(1).replace(/\\/g, ",")); c = (d && "construct" != d ? "Method" : "Constructor") + " " + a.getClassName(c, !0) + "." + d + "(" + b + ") is not found!"; throw new java.lang.NoSuchMethodException(c); }; a.prepareCallback = function (b, c) {
			var d = c[0]; if (b && d && d !== window) {
				var e = a.getClassName(d, !0), h = {}; if (b.b$) for (var j in b.b$) h[j] = b.b$[j]; b.b$ = h; h[e] = d; for (e = a.getClass(d); e.superClazz;)e = e.superClazz,
					h[a.getClassName(e, !0)] = d; if (d = d.b$) for (j in d) h[j] = d[j]
			...
			b || (b = arguments.callee.caller); var e; if (d || c.$finals) if (e = new b(c, a.inheritArgs), d) if (c.f$) { var h = {}, j; for (j in c.f$) h[j] = c.f$[j]; for (j in d) h[j] = d[j]; e.f$ = h } else e.f$ = d; else c.f$ && (e.f$ = c.f$); else switch (arguments.length) {
				case 3: return new b(c); case 4: return c.__CLASS_NAME__ == b.__CLASS_NAME__ && arguments[3] === a.inheritArgs ? c : new b(c, arguments[3]);
		...
		}; a.cloneFinals = function () { for (var a = {}, b = arguments.length / 2; 0 <= --b;)a[arguments[b + b]] = arguments[b + b + 1]; return a }; a.defineEnumConstant = function (a, b, c, d, e) { e = e ? new e : new a; e.$name = b; e.$ordinal = c; d && d.length && e.construct.apply(e, d); a[b] = e; a.prototype[b] = e; a["$ values"] || (a["$ values"] = [], a.values = function () { return this["$ values"] }); a["$ values"].push(e); return e }; a.floatToInt = function (a) {
			return isNaN(a) ?
				0 : 0 > a ? Math.ceil(a) : Math.floor(a)
		}; a.floatToByte = a.floatToShort = a.floatToLong = a.floatToInt; a.doubleToByte = a.doubleToShort = a.doubleToLong = a.doubleToInt = a.floatToInt; a.floatToChar = function (a) { return String.fromCharCode(0 > a ? Math.ceil(a) : Math.floor(a)) }; a.doubleToChar = a.floatToChar; var gb = function (a, b) { a || (a = 0); if ("object" == typeof a) var c = a; else for (var c = Array(a), d = 0; d < a; d++)c[d] = 0; c.BYTES_PER_ELEMENT = b >> 3; c._fake = !0; return c }, ta = function (a, b) {
			a || (a = 0); b || (b = this.length); if (this._fake) {
				var c = new this.constructor(b -
					a); System.arraycopy(this, a, c, 0, b - a); return c
			...
			return ta.apply(this,
				arguments)
		}); Int32Array.prototype.clone = function () { var a = this.slice(); a.BYTES_PER_ELEMENT = 4; return a }; !0 == (a.haveFloat64 = !!(self.Float64Array && self.Float64Array != Array)) ? Float64Array.prototype.sort || (Float64Array.prototype.sort = Array.prototype.sort) : (Float64Array = function (a) { return gb(a, 64) }, Float64Array.prototype.sort = Array.prototype.sort, Float64Array.prototype.toString = function () { return "[object Float64Array]" }); Float64Array.prototype.slice || (Float64Array.prototype.slice = function () {
			return ta.apply(this,
				arguments)
		}); Float64Array.prototype.clone = function () { return this.slice() }; a.newArray = function (a, b, c, d) { if (-1 != a || 2 == arguments.length) return ka(arguments, 0); a = b.slice(c, d); a.BYTES_PER_ELEMENT = b.BYTES_PER_ELEMENT; return a }; var ka = function (a, b) {
			var c = a[0]; "string" == typeof c && (c = c.charCodeAt(0)); var d = a.length - 1, e = a[d]; if (1 < d) { for (var e = Array(d), h = 0; h < d; h++)e[h] = a[h + 1]; d = Array(c); for (h = 0; h < c; h++)d[h] = ka(e, b); return d } 0 < b && 0 > c && (c = e); switch (b) {
				case 8: return d = new Int8Array(c), d.BYTES_PER_ELEMENT = 1, d; case 32: return d =
					new Int32Array(c), d.BYTES_PER_ELEMENT = 4, d; case 64: return d = new Float64Array(c), d.BYTES_PER_ELEMENT = 8, d; default: d = 0 > c ? e : Array(c); d.BYTES_PER_ELEMENT = 0; if (0 < c && null != e) for (h = c; 0 <= --h;)d[h] = e; return d
			}
		}; a.newByteArray = function () { return ka(arguments, 8) }; a.newIntArray = function () { return ka(arguments, 32) }; a.newFloatArray = function () { return ka(arguments, 64) }; a.newDoubleArray = a.newFloatArray; a.newLongArray = a.newShortArray = a.newIntArray; a.newCharArray = a.newBooleanArray = a.newArray; !0 == (a.haveInt8 = !!self.Int8Array) ?
			(Int8Array.prototype.sort || (Int8Array.prototype.sort = Array.prototype.sort), Int8Array.prototype.slice || (Int8Array.prototype.slice = function () { return ta.apply(this, arguments) })) : a.newByteArray = a.newIntArray; Int8Array.prototype.clone = function () { var a = this.slice(); a.BYTES_PER_ELEMENT = 1; return a }; a.isAB = function (a) { return a && "object" == typeof a && 1 == a.BYTES_PER_ELEMENT }; a.isAI = function (a) { return a && "object" == typeof a && 4 == a.BYTES_PER_ELEMENT }; a.isAF = function (a) { return a && "object" == typeof a && 8 == a.BYTES_PER_ELEMENT };
		a.isAS = function (a) { return a && "object" == typeof a && a.constructor == Array && ("string" == typeof a[0] || "undefined" == typeof a[0]) }; a.isAII = function (b) { return b && "object" == typeof b && a.isAI(b[0]) }; a.isAFF = function (b) { return b && "object" == typeof b && a.isAF(b[0]) }; a.isAFFF = function (b) { return b && "object" == typeof b && a.isAFF(b[0]) }; a.isASS = function (b) { return b && "object" == typeof b && a.isAS(b[0]) }; a.isAFloat = function (b) { return b && "object" == typeof b && b.constructor == Array && a.instanceOf(b[0], Float) }; a.isAP = function (b) {
			return b &&
				"JU.P3" == a.getClassName(b[0])
		}; a.defineStatics = function (a) { for (var b = arguments.length, c = (b - 1) / 2; 0 <= --c;) { var d = arguments[--b], e = arguments[--b]; a[e] = a.prototype[e] = d } }; a.prepareFields = function (a, b) { var c = []; if (a.con$truct) for (var d = a.con$truct.stacks, e = 0; e < d.length; e++)c[e] = d[e]; d = a.con$truct = function () { var a = arguments.callee.stacks; if (a) for (var b = 0; b < a.length; b++)a[b].apply(this, []) }; a.prototype.con$truct = d; c.push(b); a.con$truct.stacks = c; a.con$truct.index = 0 }; a.checkPrivateMethod = function () {
			me = arguments.callee.caller;
			caller = arguments.callee.caller.caller; var b = "\\" + a.getParamsType(arguments[0]).join("\\"); me.privateNote || (me.privateNote = "You are seeing this note because the method " + me.exName + b + " in class " + me.exClazz.__CLASS_NAME__ + " has a superclass method by the same name (possibly with the same parameters) that is private and  therefore might be called improperly from this class. If your  code does not run properly, or you want to make it run faster, change the name of this method to something else.", System.out.println(me.privateNote),
				alert(me.privateNote)); return null
		}; java.lang.Object = a._O; a._O.getName = a._innerFunctions.getName; java.lang.System = System = {
			props: null, $props: {}, arraycopy: function (a, b, c, d, e) { if (a !== c || b > d) for (; 0 <= --e;)c[d++] = a[b++]; else { d += e; for (b += e; 0 <= --e;)a[--d] = a[--b] } }, currentTimeMillis: function () { return (new Date).getTime() }, gc: function () { }, getProperties: function () { return System.props }, getProperty: function (a, b) {
				if (System.props) return System.props.getProperty(a, b); var c = System.$props[a]; if ("undefined" != typeof c) return c;
				if (0 < a.indexOf(".")) { c = null; switch (a) { case "java.version": case "file.separator": case "path.separator": c = "/"; break; case "line.separator": c = 0 <= navigator.userAgent.indexOf("Windows") ? "\r\n" : "\n"; break; case "os.name": case "os.version": c = navigator.userAgent }if (c) return System.$props[a] = c } return 1 == arguments.length ? null : null == b ? a : b
			}, getSecurityManager: function () { return null }, setProperties: function (a) { System.props = a }, lineSeparator: function () { return "\n" }, setProperty: function (a, b) {
				if (!System.props) return System.$props[a] =
					b; System.props.setProperty(a, b)
			}
		}; System.identityHashCode = function (b) { return null == b ? 0 : b._$hashcode || (b._$hashcode = ++a._hashCode) }; System.out = new a._O; System.out.__CLASS_NAME__ = "java.io.PrintStream"; System.out.print = function () { }; System.out.printf = function () { }; System.out.println = function () { }; System.out.write = function () { }; System.out.flush = function () { }; System.err = new a._O; System.err.__CLASS_NAME__ = "java.io.PrintStream"; System.err.print = function () { }; System.err.printf = function () { }; System.err.println = function () { };
		System.err.write = function () { }; System.err.flush = function () { }; a.popup = a.assert = a.log = a.error = window.alert; Thread = function () { }; Thread.J2S_THREAD = Thread.prototype.J2S_THREAD = new Thread; Thread.currentThread = Thread.prototype.currentThread = function () { return this.J2S_THREAD }; a.innerFunctionNames = a.innerFunctionNames.concat("getSuperclass isAssignableFrom getConstructor getDeclaredMethod getDeclaredMethods getMethod getMethods getModifiers newInstance".split(" ")); a._innerFunctions.getSuperclass = function () { return this.superClazz };
		a._innerFunctions.isAssignableFrom = function (b) { return 0 <= a.getInheritedLevel(b, this) }; a._innerFunctions.getConstructor = function () { return new java.lang.reflect.Constructor(this, [], [], java.lang.reflect.Modifier.PUBLIC) }; a._innerFunctions.getDeclaredMethods = a._innerFunctions.getMethods = function () {
			var a = [], b = this.prototype, c; for (c in b) "function" == typeof b[c] && !b[c].__CLASS_NAME__ && a.push(new java.lang.reflect.Method(this, c, [], java.lang.Void, [], java.lang.reflect.Modifier.PUBLIC)); b = this; for (c in b) "function" ==
				typeof b[c] && !b[c].__CLASS_NAME__ && a.push(new java.lang.reflect.Method(this, c, [], java.lang.Void, [], java.lang.reflect.Modifier.PUBLIC | java.lang.reflect.Modifier.STATIC)); return a
		}; a._innerFunctions.getDeclaredMethod = a._innerFunctions.getMethod = function (a) {
			var b = this.prototype, c; for (c in b) if (a == c && "function" == typeof b[c] && !b[c].__CLASS_NAME__) return new java.lang.reflect.Method(this, c, [], java.lang.Void, [], java.lang.reflect.Modifier.PUBLIC); b = this; for (c in b) if (a == c && "function" == typeof b[c] && !b[c].__CLASS_NAME__) return new java.lang.reflect.Method(this,
				c, [], java.lang.Void, [], java.lang.reflect.Modifier.PUBLIC | java.lang.reflect.Modifier.STATIC); return null
		}; a._innerFunctions.getModifiers = function () { return java.lang.reflect.Modifier.PUBLIC }; a._innerFunctions.newInstance = function (a) {
			switch (null == a ? 0 : a.length) {
				case 0: return new this; case 1: return new this(a[0]); case 2: return new this(a[0], a[1]); case 3: return new this(a[0], a[1], a[2]); case 4: return new this(a[0], a[1], a[2], a[3]); default: for (var b = "new " + this.__CLASS_NAME__ + "(", c = 0; c < a.length; c++)b += (0 ==
					c ? "" : ",") + "a[" + c + "]"; return eval(b + ")")
			}
		}; j = a.innerFunctionNames; for (q = 0; q < j.length; q++)a._O[j[q]] = a._innerFunctions[j[q]], Array[j[q]] = a._innerFunctions[j[q]]; a._Loader = a.ClazzLoader = function () { }; var w = function () { this.parents = []; this.musts = []; this.optionals = []; this.onLoaded = this.path = this.name = this.declaration = null; this.status = 0; this.random = 0.13412 }; (function (a, b) {
			b._checkLoad = m._checkLoad; b.updateNodeForFunctionDecoration = function (a) {
				(a = G(a)) && a.status == w.STATUS_KNOWN && window.setTimeout(function (a) { return function () { updateNode(a) } }(a),
					1)
			}; w.prototype.toString = function () { return this.name || this.path || "ClazzNode" }; w.STATUS_UNKNOWN = 0; w.STATUS_KNOWN = 1; w.STATUS_CONTENT_LOADED = 2; w.STATUS_MUSTS_LOADED = 3; w.STATUS_DECLARED = 4; w.STATUS_LOAD_COMPLETE = 5; var c = []; b.requireLoaderByBase = function (a) { for (var d = 0; d < c.length; d++)if (c[d].base == a) return c[d]; d = new b; d.base = a; c.push(d); return d }; var d = new w, e = {}, h = 0, j = 6, l = navigator.userAgent.toLowerCase(), q = -1 != l.indexOf("opera"), s = -1 != l.indexOf("msie") && !q, f = -1 != l.indexOf("gecko"); if (q && (j = 1, q = l.indexOf("opera/"),
				-1 != q)) { var t = 9; try { t = parseFloat(l.subString(q + 6)) } catch (u) { } 9.6 <= t && (j = 6) } var B; self.Clazz && a.isClassDefined ? isClassDefined = a.isClassDefined : (B = {}, isClassDefined = function (a) { return !0 == B[a] }); var C = function (a) { if (!a || 0 == a.length) return []; for (var b = null, c = 0; c < a.length; c++)if (a[c]) { if ("$" == a[c].charAt(0)) if ("." == a[c].charAt(1)) { if (!b) continue; var d = b.lastIndexOf("."); -1 != d && (b = b.substring(0, d), a[c] = b + a[c].substring(1)) } else a[c] = "org.eclipse.s" + a[c].substring(1); b = a[c] } return a }, H = [], D = {}, K = 0; b.loadPackageClasspath =
					function (a, c, d, e, f, h) {
						f || (f = 0); e || (e = null); h || (h = 0); var j = d && D["@" + a]; if (0 == f && (d && !D["@java"] && 0 != a.indexOf("java") && null != window["java.registered"] && !D["@java"]) && (b.loadPackage("java", e ? function () { b.loadPackageClasspath(a, c, d, e, 1) } : null), e)) return; if (a instanceof Array) if (C(a), e) h < a.length ? b.loadPackageClasspath(a[h], c, d, function () { b.loadPackageClasspath(a, c, d, e, 1, h + 1) }, 1) : e(); else for (f = 0; f < a.length; f++)b.loadPackageClasspath(a[f], c, d, null); else {
							switch (a) {
								case "java.*": a = "java"; case "java": break;
								default: a.lastIndexOf(".*") == a.length - 2 && (a = a.substring(0, a.length - 2))
							}c && (D["@" + a] = c); d && !j && !window[a + ".registered"] ? (K++, "java" == a && (a = "core"), b.loadClass(a + ".package", function () { 0 == --K && ca() }, !0, !0, 1)) : e && e()
						}
						...
						l || (l = 0); null == j && (j = !1); if ("boolean" == typeof f) return a.evalType(c); null != window["java.registered"] && !D["@java"] && b.loadPackage("java");
						b.keepOnLoading = !0; if (!h && (K && c.lastIndexOf(".package") != c.length - 8 || 0 != c.indexOf("java.") && !isClassDefined(pa))) Ja.push([c, f]); else if ((l = isClassDefined(c)) || L["@" + c]) { if (l && f && (h = G(c), !h || h.status >= w.STATUS_LOAD_COMPLETE)) j ? window.setTimeout(f, 25) : f() } else {
							var m = b.getClasspathFor(c); l = e[m]; if (!l) for (j = H.length; 0 <= --j;)if (H[j].path == m || H[j].name == c) { l = !0; break } if (l) { if (f && (l = G(c))) if (l.onLoaded) { if (f != l.onLoaded) { var r = l.onLoaded, q = f; l.onLoaded = function () { r(); q() } } } else l.onLoaded = f } else {
								l = a.unloadedClasses[c] &&
								G(c) || new w; l.name = c; l.path = m; l.isPackage = m.lastIndexOf("package.js") == m.length - 10; Y(m, c, l); l.onLoaded = f; l.status = w.STATUS_KNOWN; c = !1; for (j = H.length; 0 <= --j;)if (H[j].status != w.STATUS_LOAD_COMPLETE) { c = !0; break } if (l.isPackage) { for (j = H.length; 0 <= --j && !H[j].isPackage;)H[j + 1] = H[j]; H[++j] = l } else c && H.push(l); if (!c) { var s = !1; f && (s = fa, fa = !0); h && (f = null); Ha(d, l, !0); V(l, l.path, l.requiredBy, !1, f ? function () { fa = s; f() } : null) }
							}
						}
					}; b.loadPackage = function (a, c) {
						c || (c = null); window[a + ".registered"] = !1; b.loadPackageClasspath(a,
							b.J2SLibBase || (b.J2SLibBase = b.getJ2SLibBase() || "j2s/"), !0, c)
					}; b.jarClasspath = function (a, b) { b instanceof Array || (b = [b]); C(b); m._debugCore && (a = a.replace(/\.z\./, ".")); for (var c = b.length; 0 <= --c;)D["#" + b[c]] = a; D["$" + a] = b }; b.registerPackages = function (c, d) { for (var e = b.getClasspathFor(c + ".*", !0), f = 0; f < d.length; f++)window.Clazz && a.declarePackage(c + "." + d[f]), b.loadPackageClasspath(c + "." + d[f], e) }; b.getClasspathFor = function (c, d, e) {
						var f = D["#" + c]; if (!f || d || e) {
							var h, j; if (f) {
								if (c = c.replace(/\./g, "/"), 0 <= (j = f.lastIndexOf(c)) ||
									0 <= (j = c.lastIndexOf("/")) && 0 <= (j = f.lastIndexOf(c.substring(0, j)))) h = f.substring(0, j)
							} else { for (j = c.length + 2; 0 <= (j = c.lastIndexOf(".", j - 2)) && !(h = D["@" + c.substring(0, j)]);); d || (c = c.replace(/\./g, "/")) } null == h && (h = window.Clazz && a.binaryFolders && a.binaryFolders.length ? a.binaryFolders[0] : b.binaryFolders && b.binaryFolders.length ? b.binaryFolders[0] : "j2s"); f = (h.lastIndexOf("/") == h.length - 1 ? h : h + "/") + (d ? "" : c.lastIndexOf("/*") == c.length - 2 ? c.substring(0, j + 1) : c + (!e ? ".js" : "." != e.charAt(0) ? "." + e : e))
						} return f
					}; b.ignore =
						function () { var a = 1 == arguments.length && arguments[0] instanceof Array ? a = arguments[0] : null, b = a ? a.length : arguments.length; if (!a) for (var a = Array(b), c = 0; c < b; c++)a[c] = arguments[c]; C(a); for (c = 0; c < b; c++)L["@" + a[c]] = 1 }; b.onScriptLoading = function () { }; b.onScriptLoaded = function () { }; b.onScriptInitialized = function () { }; b.onScriptCompleted = function () { }; b.onClassUnloaded = function () { }; b.onGlobalLoaded = function () { }; b.keepOnLoading = !0; var R = {}, L = {}, T = function (c, d, e, f) {
							if (!f) try { eval(e + ";//# sourceURL=" + c) } catch (h) {
								if (a._isQuiet) return;
								c = "[Java2Script] The required class file \n\n" + c + (0 == e.indexOf("[Exception") && e.indexOf("data: no") ? "\nwas not found.\n" : "\ncould not be loaded. Script error: " + h.message + " \n\ndata:\n\n" + e) + "\n\n" + a.getStackTrace(); alert(c); a.alert(c); throw h;
							} b.onScriptLoaded(c, !1); sa(d)
						}, U = function (a) { return function () { if ("interactive" != a.readyState) { try { a.parentNode && a.parentNode.removeChild(a) } catch (b) { } a = null } } }, W = function (a) { window["j2s.script.debugging"] || window.setTimeout(U(a), 1) }; a._4Name = function (c, d, e) {
							if (a.isClassDefined(c)) return a.evalType(c);
							d = m._isAsync && d ? d._restoreState(c, e) : null; if (1 == d) return null; if (b.setLoadingMode(d ? b.MODE_SCRIPT : "xhr.sync")) return b.loadClass(c, d, !1, !0, 1), null; b.loadClass(c); return a.evalType(c)
						}; a.currentPath = ""; var V = function (c, d, f, j, l) {
							a.currentPath = d; j && alert("WHY>>"); j = e[d]; e[d] = !0; Ya(H, d); I = !0; ra = !1; b._checkLoad && System.out.println("\t" + d + (f ? "\n -- required by " + f : "") + "  ajax=" + I + " async=" + ra); f = d; a._debugging && (d = d.replace(/\.z\.js/, ".js")); j || System.out.println("loadScript " + d); b.onScriptLoading(d); if (I &&
								!ra) { var r = m._getFileData(d); try { T(d, f, r, j) } catch (q) { alert(q + " loading file " + d + " " + c.name + " " + a.getStackTrace()) } l && l() } else c = { dataType: "script", async: !0, type: "GET", url: d, success: ba(d, !1, l), error: ba(d, !0, l) }, h++, j ? setTimeout(c.success, 0) : m.$ajax(c)
						}, ba = function (c, d, e) {
							a.getStackTrace(); return function () {
								f && this.timeoutHandle && (window.clearTimeout(this.timeoutHandle), this.timeoutHandle = null); 0 < h && h--; this.onerror = this.onload = null; d && alert("There was a problem loading " + c); b.onScriptLoaded(c, !0);
								var a = this, j; j = e ? function () { W(a); sa(c, e) } : function () { W(a); sa(c) }; 0 <= X ? window.setTimeout(function () { sa(c, j) }, X) : sa(c, j)
							}
						}, fa = !0, ea = !1, sa = function (c, f) {
							var l = R["@" + c]; if (l) {
								var m, r = D["$" + c]; if (r) for (var q = 0; q < r.length; q++) {
									var t = r[q]; if (t != l.name && (m = G(t))) m.status < w.STATUS_CONTENT_LOADED && (m.status = w.STATUS_CONTENT_LOADED, updateNode(m)); else {
										m = new w; m.name = t; var u = D["#" + t]; u || (alert(t + " J2S error in tryToLoadNext"), error("Java2Script implementation error! Please report this bug!")); m.path = u; Y(m.path,
											t, m); m.status = w.STATUS_CONTENT_LOADED; Ha(d, m, !1); updateNode(m)
									}
								} if (l instanceof Array) for (q = 0; q < l.length; q++)l[q].status < w.STATUS_CONTENT_LOADED && (l[q].status = w.STATUS_CONTENT_LOADED, updateNode(l[q])); else if (l.status < w.STATUS_CONTENT_LOADED) {
									m = !1; r = document.getElementsByTagName("SCRIPT"); for (q = 0; q < r.length; q++)if (s) { if (r[q].onreadystatechange && r[q].onreadystatechange.path == l.path && "interactive" == r[q].readyState) { m = !0; break } } else if (r[q].onload && r[q].onload.path == l.path) { m = !0; break } m || (l.status = w.STATUS_CONTENT_LOADED,
										updateNode(l))
								} if (b.keepOnLoading) {
									q = !0; if (m = Ia(w.STATUS_KNOWN)) for (Q(m); h < j && (m = Ia(w.STATUS_KNOWN));)Q(m); else if (0 != H.length) m = H.shift(), !e[m.path] || 0 != H.length || !fa || m.musts.length || m.optionals.length ? (Ha(d, m, !0), V(m, m.path, m.requiredBy, !1)) : fa && (fa = !1); else if (m = F(w.STATUS_KNOWN)) for (Q(m); h < j && (m = F(w.STATUS_KNOWN));)Q(m); else q = !1; if (!(q || 0 < h)) {
										l = [Ia, F]; r = null; for (q = 0; 2 > q; q++)for (; m = l[q](w.STATUS_CONTENT_LOADED);)1 == q && r === m && (m.status = w.STATUS_LOAD_COMPLETE), updateNode(m), r = m; for (; !(ka = [], !la(d,
											c));); for (q = 0; 2 > q; q++)for (r = null; (m = l[q](w.STATUS_DECLARED)) && r !== m;)updateNode(r = m); r = []; for (q = 0; 2 > q; q++)for (; m = l[q](w.STATUS_DECLARED);)r.push(m), m.status = w.STATUS_LOAD_COMPLETE; if (r.length) { for (q = 0; q < r.length; q++)Ba(r[q]); for (q = 0; q < r.length; q++)if (l = r[q].onLoaded) r[q].onLoaded = null, l() } if (f) f(); else if (b._classCountPending) for (t in b._classPending) { if (m = G(t), System.out.println("class left pending " + t + " " + m), m) { updateNode(m); break } } else b._checkLoad && (System.out.println("I think I'm done: SAEM call count: " +
												O), a.showDuplicates(!0)); b.onGlobalLoaded()
									}
								}
							}
						}, ka = [], la = function (a, c) {
							var d = ka, e = d.length; d.push(a); for (var f = e; 0 <= --f && !(d[f] === a && d[f].status >= w.STATUS_DECLARED);); if (0 <= f) {
								if (b._checkLoad) { var h; System.out.println("cycle found loading " + c + " for " + a) } for (; f < e; f++) {
									var j = d[f]; j.status = w.STATUS_LOAD_COMPLETE; Ba(j); for (h = 0; h < j.parents.length; h++)updateNode(j.parents[h]); j.parents = []; var k = j.onLoaded; b._checkLoad && (h = "cycle setting status to LOAD_COMPLETE for " + j.name + (k ? " firing " + k.toString() : ""),
										System.out.println(h)); k && (j.onLoaded = null, k())
								} d.length = 0; return !0
							} j = [a.musts, a.optionals]; for (h = 0; 2 > h; h++) { k = j[h]; for (f = k.length; 0 <= --f;)if (k[f].status == w.STATUS_DECLARED && la(k[f], c)) return !0 } d.length = e; return !1
						}; b._classCountPending = 0; b._classCountOK = 0; b._classPending = {}; b.showPending = function () { var a = [], c; for (c in b._classPending) { var d = G(c); d ? (a.push(d), System.out.println(ta("", "", d, "", 0))) : alert("No node for " + c) } return a }; var ta = function (a, b, c, d, e) {
							b += "--" + c.name; a += b + "\n"; if (5 < e) return a +
								(d + " ...\n"); d += "\t"; a += d + "status: " + c.status + "\n"; if (c.parents && c.parents.length && c.parents[0] && c.parents[0].name) { a += d + "parents: " + c.parents.length + "\n"; for (var f = 0; f < c.parents.length; f++)a = ta(a, b, c.parents[f], d + "\t", e + 1); a += "\n" } return a
						}; updateNode = function (a) {
							if (!a.name || a.status >= w.STATUS_LOAD_COMPLETE) Ba(a); else {
								var c = !0; if (a.musts.length && a.declaration) for (var d = a.musts.length, e = d; 0 <= --e;) {
									var f = a.musts[e]; f.requiredBy = a; if (f.status < w.STATUS_DECLARED && isClassDefined(f.name)) {
										var h = []; f.status =
											w.STATUS_LOAD_COMPLETE; Ba(f); if (f.declaration && f.declaration.clazzList) { for (var j = 0, k = f.declaration.clazzList, l = k.length; j < l; j++) { var m = G(k[j]); m && (m.status != w.STATUS_LOAD_COMPLETE && m !== f) && (m.status = f.status, m.declaration = null, Ba(m), m.onLoaded && h.push(m)) } f.declaration = null } f.onLoaded && h.push(f); for (j = 0; j < h.length; j++)if (k = h[j].onLoaded) h[j].onLoaded = null, k()
									} else f.status == w.STATUS_CONTENT_LOADED && updateNode(f), f.status < w.STATUS_DECLARED && (c = !1); a.musts.length != d && (e = d = a.musts.length, c = !0)
								} if (c) {
									if (a.status <
										w.STATUS_DECLARED) { if (e = a.declaration) e(), e.executed = !0; b._checkLoad && b._classPending[a.name] && (delete b._classPending[a.name], b._classCountOK, b._classCountPending--); a.status = w.STATUS_DECLARED; B && (B[a.name] = !0); b.onScriptInitialized(a.path); if (a.declaration && a.declaration.clazzList) { j = 0; k = a.declaration.clazzList; for (l = k.length; j < l; j++)if ((m = G(k[j])) && m.status != w.STATUS_DECLARED && m !== a) m.status = w.STATUS_DECLARED, B && (B[m.name] = !0), b.onScriptInitialized(m.path) } } c = w.STATUS_DECLARED; if (0 == a.optionals.length &&
											0 == a.musts.length || a.status > w.STATUS_KNOWN && !a.declaration || Sa(a.musts, w.STATUS_LOAD_COMPLETE) && Sa(a.optionals, w.STATUS_LOAD_COMPLETE)) { c = w.STATUS_LOAD_COMPLETE; if (!ua(a, c)) return !1; if (a.declaration && a.declaration.clazzList) { j = 0; k = a.declaration.clazzList; for (l = k.length; j < l; j++)if ((m = G(k[j])) && m.status != c && m !== a) if (m.declaration = null, !ua(m, c)) return !1 } } if (a.parents && a.parents.length) {
												for (e = 0; e < a.parents.length; e++)j = a.parents[e], j.status < c && updateNode(j, j.name); c == w.STATUS_LOAD_COMPLETE && (a.parents =
													[])
											}
								}
							}
						}; var Sa = function (a, b) { for (var c = a.length; 0 <= --c;)if (a[c].status < b) return !1; return !0 }, ua = function (a, c) { a.status = c; b.onScriptCompleted(a.path); var d = a.onLoaded; if (d && (a.onLoaded = null, d(), !b.keepOnLoading)) return !1; Ba(a); return !0 }, wa = { "r0.13412": 1 }, za = function () { for (; ;) { var a = Math.random(), b = "r" + a; if (!wa[b]) return wa[b] = 1, d.random = a } }, G = function (a) { za(); return Ca(a, d) }, F = function (a) { za(); return Aa(d, a) }, Ia = function (a) { return oa(d, a) }, Ca = function (a, b) {
							var c; return b.name == a ? b : (c = $a(a, b.musts)) ||
								(c = $a(a, b.optionals)) ? c : null
						}, $a = function (a, b) { for (var c = d.random, e = b.length; 0 <= --e;) { var f = b[e]; if (f.name == a || f.random != c && (f.random = c, f = Ca(a, f))) return f } return null }, ya = function (a, b) { return a.status == b && (b != w.STATUS_KNOWN || !e[a.path]) && (b == w.STATUS_DECLARED || !isClassDefined(a.name)) }, oa = function (a, b) { for (var c = a.musts.length; 0 <= --c;) { var d = a.musts[c]; if (ya(d, b) || (d = oa(d, b))) return d } return ya(a, b) ? a : null }, Aa = function (a, b) { var c; return (c = ma(a.musts, b)) || (c = ma(a.optionals, b)) || ya(c = a, b) ? c : null },
							ma = function (a, b) { if (a) for (var c = d.random, e = 0; e < a.length; e++) { var f = a[e]; if (ya(f, b) || f.random != c && (f.random = c, f = Aa(f, b))) return f } return null }, P = function (a, c, e, f) {
								if (c instanceof Array) { C(c); for (var h = 0; h < c.length; h++)P(a, c[h], e, f, c) } else {
									b._checkLoad && !b._classPending[c] && (b._classPending[c] = 1, 0 == b._classCountPending++ && (b._classCountOK = 0), System.out.println("Loading class " + c)); h = R["#" + c]; h || (h = (h = G(c)) ? h : new w, h.name = c, h.path = D["#" + c] || "unknown", Y(h.path, c, h), h.status = w.STATUS_KNOWN, Ha(d, h, !1));
									ha(h, a, !0); 5 == arguments.length && f && (f.status = h.status, f.clazzList = arguments[4]); if (h.declaration = f) h.status = w.STATUS_CONTENT_LOADED; ha(h, e, !1)
								}
							}, ha = function (a, b, c) { if (b && b.length) { C(b); for (var d = 0; d < b.length; d++) { var e = b[d]; if (e && !isClassDefined(e) && !L["@" + e]) { var f = G(e); f || (f = new w, f.name = e, f.status = w.STATUS_KNOWN); f.requiredBy = a; Ha(a, f, c) } } } }; window.Clazz ? a.load = P : b.load = P; var Y = function (a, b, c) {
								var d = "@" + a; if (a = R[d]) if (a instanceof Array) {
									for (var d = !1, e = 0; e < a.length; e++)if (a[e].name == b) { d = !0; break } d ||
										a.push(c)
								} else R[d] = [a, c]; else R[d] = c; R["#" + b] = c
							}, Q = function (a) { var c = a.name; if (!isClassDefined(c) && !L["@" + c]) { var d = b.getClasspathFor(c); a.path = d; Y(d, c, a); if (!e[d]) return V(a, d, a.requiredBy, !1), !0 } return !1 }, pa = b.runtimeKeyClass = "java.lang.String", Ja = []; b.getJ2SLibBase = function () { var a = window["j2s.lib"]; return a ? a.base + ("." == a.alias ? "" : (a.alias ? a.alias : a.version ? a.version : "1.0.0") + "/") : null }; var ra = !0, I = !1, X = -1; b.MODE_SCRIPT = 4; b.MODE_XHR = 2; b.MODE_SYNC = 1; b.setLoadingMode = function (a, c) {
								var d = !0, e = !0;
								"string" == typeof a ? (a = a.toLowerCase(), 0 <= a.indexOf("script") ? e = !1 : a.indexOf("async"), d = !1) : a & b.MODE_SCRIPT ? e = !1 : d = !(a & b.MODE_SYNC); I = e; X = (ra = d) && 0 <= c ? c : -1; return d
							}; var ca = function () { if (!K && isClassDefined(pa)) { for (var a = Ja, c = 0; c < a.length; c++)b.loadClass(a[c][0], a[c][1]); Ja = [] } }; b.loadZJar = function (a, c) { var d = null, e = c instanceof Array; e ? c = c[c.length - 1] : d = c == pa ? ca : null; b.jarClasspath(a, e ? c : [c]); b.loadClass(c, d, !0) }; var Da = {}, Na = [], Ha = function (a, b, c) {
								var e = !1; c ? (c = a.musts, b.requiredBy || (b.requiredBy =
									a)) : c = a.optionals; Da[b.name] || (Na.push(b), Da[b.name] = b); for (var f = 0; f < c.length; f++)if (c[f].name == b.name) { e = !0; break } e || (c.push(b), fa && (0 != b.name.indexOf("java") && 0 != b.name.indexOf("net.sf.j2s.ajax")) && (ea && (fa = !1), ea = !0)); a: { if (a.name && a != d && a != b) for (e = 0; e < b.parents.length; e++)if (b.parents[e].name == a.name) break a; b.parents.push(a) }
		...
		a._LoaderProgressMonitor = {}; var V = a._LoaderProgressMonitor, H = null, ea = 0, L = null, ua = 0; V.DEFAULT_OPACITY = m && m._j2sLoadMonitorOpacity ? m._j2sLoadMonitorOpacity : 55; V.hideMonitor = function () { L.style.display = "none" }; V.showStatus = function (a, b) {
			if (!L) {
				var c = document.createElement("DIV"); c.id = "_Loader-status"; c.style.cssText = "position:absolute;bottom:4px;left:4px;padding:2px 8px;z-index:" + (window["j2s.lib"].monitorZIndex || 1E4) + ";background-color:#8e0000;color:yellow;font-family:Arial, sans-serif;font-size:10pt;white-space:nowrap;";
				c.onmouseover = ub; L = c; document.body.appendChild(c); wa || (wa = !0)
			} jb(L); if (null == a) b ? la() : V.hideMonitor(); else {
				L.appendChild(document.createTextNode("" + a)); "none" == L.style.display && (L.style.display = ""); kb(V.DEFAULT_OPACITY); var d, c = navigator.userAgent; d = document.body; var e = d.parentNode, h = e.clientHeight; d = d.scrollTop + d.offsetTop; var j = e.scrollTop + e.offsetTop, c = 0 > c.indexOf("Opera") && document.all ? 0 == h ? d : j : 0 > c.indexOf("Gecko") ? h == e.offsetHeight && h == e.scrollHeight ? d : j : d; ua != c && (ua = c, L.style.bottom = ua + 4 + "px");
				b && la()
			}
		}; var jb = function (a) { if (a) for (var b = a.childNodes.length; 0 <= --b;) { var c = a.childNodes[b]; if (c) { c.childNodes && c.childNodes.length && jb(c); try { a.removeChild(c) } catch (d) { } } } }, kb = function (a) { H && a == V.DEFAULT_OPACITY && (window.clearTimeout(H), H = null); ea = a; navigator.userAgent.toLowerCase(); L.style.filter = "Alpha(Opacity=" + a + ")"; L.style.opacity = a / 100 }, ub = function () { V.hideMonitor() }, wa = !1, la = function () {
			"none" != L.style.display && (ea == V.DEFAULT_OPACITY ? (H = window.setTimeout(function () { la() }, 750), ea -= 5) : 0 <=
				ea - 10 ? (kb(ea - 10), H = window.setTimeout(function () { la() }, 40)) : L.style.display = "none")
		}, B = a.Console, W = System; B.maxTotalLines = 1E4; B.setMaxTotalLines = function (a) { B.maxTotalLines = 0 < a ? a : 999999 }; B.maxLatency = 40; B.setMaxLatency = function (a) { B.maxLatency = 0 < a ? a : 40 }; B.pinning = !1; B.enablePinning = function (a) { B.pinning = a }; B.linesCount = 0; B.metLineBreak = !1; B.createConsoleWindow = function () { var a = document.createElement("DIV"); a.style.cssText = "font-family:monospace, Arial, sans-serif;"; document.body.appendChild(a); return a };
		var ba = String.fromCharCode(160), ba = ba + (ba + ba + ba); B.consoleOutput = function (a, b) {
			var c = window["j2s.lib"]; (c = c && c.console) && "string" == typeof c && (c = document.getElementById(c)); if (!c) return !1; if (B.linesCount > B.maxTotalLines) { for (var d = 0; d < B.linesCount - B.maxTotalLines; d++)c && 0 < c.childNodes.length && c.removeChild(c.childNodes[0]); B.linesCount = B.maxTotalLines } var e = !1; a = ("undefined" == typeof a ? "" : null == a ? "null" : "" + a).replace(/\t/g, ba); if (0 < a.length) switch (a.charAt(a.length - 1)) {
				case "\n": case "\r": a = 1 < a.length ?
					a.substring(0, a.length - ("\r" == a.charAt(a.length - 2) ? 2 : 1)) : "", e = !0
			}var h = null; a = a.replace(/\t/g, ba); for (var h = a.split(/\r\n|\r|\n/g), d = 0, j = h.length - 1; d <= j; d++) {
				var l = null; if (B.metLineBreak || 0 == B.linesCount || 1 > c.childNodes.length) l = document.createElement("DIV"), c.appendChild(l), l.style.whiteSpace = "nowrap", B.linesCount++; else try { l = c.childNodes[c.childNodes.length - 1] } catch (m) { l = document.createElement("DIV"), c.appendChild(l), l.style.whiteSpace = "nowrap", B.linesCount++ } var q = document.createElement("SPAN");
				l.appendChild(q); q.style.whiteSpace = "nowrap"; b && (q.style.color = b); l = h[d]; 0 == l.length && (l = ba); q.appendChild(document.createTextNode(l)); B.pinning || (c.scrollTop += 100); B.metLineBreak = d != j || e
			...
			try {
				B.metLineBreak = !0; var a = window["j2s.lib"], b = a && a.console; if (b && (b = document.getElementById(b))) {
					for (var c = b.childNodes, d = c.length; 0 <=
						--d;)b.removeChild(c[d]); B.linesCount = 0
				}
			} catch (e) { }
		}; a.alert = function (a) { B.consoleOutput(a + "\r\n"); m.clazzAlert(a) }; W.out.print = function (a) { B.consoleOutput(a) }; W.out.println = function (a) { B.consoleOutput("undefined" == typeof a ? "\r\n" : null == a ? "null\r\n" : a + "\r\n") }; W.out.write = function (a, b, c) { W.out.print(String.instantialize(a).substring(b, b + c)) }; W.err.__CLASS_NAME__ = "java.io.PrintStream"; W.err.print = function (a) { B.consoleOutput(a, "red") }; W.err.println = function (a) {
			B.consoleOutput("undefined" == typeof a ?
				"\r\n" : null == a ? "null\r\n" : a + "\r\n", "red")
		}; W.err.write = function (a, b, c) { W.err.print(String.instantialize(a).substring(b, b + c)) }
	}(Clazz, Jmol))
};
