Pages = [
  ////////// 1 - intro \\\\\\\\\\
  {
    ...
    Text    : 'NV Organon is een bedrijf dat wereldwijd medicijnen ontwikkelt, produceert en verkoopt.\
               ...
               ??????????Ook kom je knoppen tegen die het molecuul dat je links in beeld kunt zien laat bewegen. Klik maar een op dit knopje??????????: \
               ',
    Help    : null,
    Note    : null,
...
//    ViewScr : 'load ok.mol; frames all; color atoms [x001E55]; spacefill off; wireframe off; moveto 0 1 0 0 90 0 0 -55; wireframe 60; set spinX 90; set spinY 0; set spinZ 0; echo; moveto 1 0 0 0 0 0 0 0; spin on;',
  ...
  ////////// 8 - set the right donors acceptors for the R1 group (R1B) \\\\\\\\\\
  {
    ...
    Answers : [
      ...
      },
      {
        ...
        Choice   : 'Fout, deze groep heeft naast dat de pocket optimaal gevuld wordt ook nog de mogelijkheid om extra waterstofbruggen te vormen tussen het molecuul en de holte. Echter in dit molecuul passen de waterstofbruggen tussen het molecuul en het eiwit niet goed (niet donor met acceptor, en acceptor met donor), probeer een ander antwoord.',
  ...
  ////////// 9 - find the right R2 group \\\\\\\\\\
  {
    ...
    Answers : [
      ...
      {
        Answer   : 'Groep 3',
        Help     : 'Kijk eens goed naar het model van dit molecuul in het eiwit, vult deze groep de ruimte in de holte goed op, en is er nog de mogelijkheid om waterstofbruginteracties te gebruiken?',
